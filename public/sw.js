if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    s[c] = Promise.all(i.map((e) => o[e] || t(e))).then((e) => (a(...e), r));
  };
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: "/_next/static/ZgY0w-IKSCbeoSoOp9rnf/_buildManifest.js",
          revision: "4bce25a8b322a3546ef67bd9a661b041",
        },
        {
          url: "/_next/static/ZgY0w-IKSCbeoSoOp9rnf/_ssgManifest.js",
        ...
        },
        {
          ...
          revision: "ZgY0w-IKSCbeoSoOp9rnf",
        },
        {
