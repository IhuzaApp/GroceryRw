...
export const MODULE_DESCRIPTIONS: Record<PrivilegeKey, ModuleDescription> = {
  checkout: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Checkout",
        description: "Can access the checkout page",
      },
      {
  ...
  staff_management: {
    ...
    actions: [
      ...
      },
      {
        key: "assign_roles",
        label: "Assign Roles",
        description: "Can assign roles to staff",
      },
      {
    ...
    actions: [
      {
        ...
        description: "Can access inventory page",
      },
      {
        key: "view_products",
        label: "View Products",
      ...
      },
      {
        ...
        description: "Can export product data",
      },
      {
      ...
      },
      {
        key: "update_stock",
        label: "Update Stock",
        description: "Can update stock quantities",
      },
    ],
  },
  transactions: {
    ...
    actions: [
      {
        ...
        description: "Can access transactions page",
      },
      {
        key: "view",
  ...
  discounts: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Discounts",
        description: "Can access discounts page",
      },
      {
        key: "create_discount",
      ...
      },
      {
        key: "edit_discount",
        label: "Edit Discount",
        description: "Can edit discount details",
      },
      {
        key: "view_discounts",
        label: "View Discounts",
        description: "Can view discount listings",
      },
      {
        key: "apply_discount",
    ...
    actions: [
      {
        ...
        description: "Can access company dashboard",
      },
      {
        key: "view_reports",
        label: "View Reports",
    ...
    actions: [
      {
        key: "access",
        label: "Access Dashboard",
        description: "Can access shop dashboard",
      },
      {
        key: "view_sales_data",
  ...
  financial_overview: {
    ...
    actions: [
      ...
      },
      {
        key: "view_profits",
        label: "View Profits",
        description: "Can view profit information",
      },
      {
    ...
    actions: [
      {
        ...
        description: "Can access POS terminal",
      },
      {
        key: "park_sale",
        label: "Park Sale",
        description: "Can park a sale for later",
      },
      {
        key: "hold_order",
        label: "Hold Order",
        description: "Can hold an order",
      },
      {
        key: "resume_order",
        label: "Resume Order",
        description: "Can resume a held order",
      },
      {
        key: "process_sale",
        label: "Process Sale",
        description: "Can process a sale",
      },
      {
        key: "view_cart",
        label: "View Cart",
        description: "Can view shopping cart",
      },
      {
        key: "edit_cart",
        label: "Edit Cart",
        description: "Can edit shopping cart",
      },
      {
    ...
    actions: [
      {
        ...
        description: "Can access products page",
      },
      {
        key: "view_products",
        label: "View Products",
      ...
      },
      {
        key: "view_analytics",
        label: "View Analytics",
        description: "Can view product analytics",
      },
    ],
  },
  orders: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Orders",
        description: "Can access orders page",
      },
      {
        key: "view_orders",
        label: "View Orders",
      ...
      },
      {
        ...
        description: "Can process orders",
      },
      {
        key: "cancel_orders",
        label: "Cancel Orders",
    ...
    actions: [
      {
        key: "access",
        label: "Access Users",
        description: "Can access users page",
      },
      {
        key: "add_users",
        label: "Add Users",
    ...
    actions: [
      {
        key: "access",
        label: "Access Shops",
        description: "Can access shops page",
      },
      {
        key: "add_shops",
        label: "Add Shops",
        description: "Can add new shops",
      },
      {
        key: "edit_shops",
        label: "Edit Shops",
        description: "Can edit shop details",
      },
      {
        key: "delete_shops",
        label: "Delete Shops",
      ...
      },
      {
        key: "view_shops",
        label: "View Shops",
        description: "Can view shop listings",
      },
      {
  ...
  shoppers: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Shoppers",
        description: "Can access shoppers page",
      },
      {
        key: "add_shoppers",
        label: "Add Shoppers",
        description: "Can add new shoppers",
      },
      {
        key: "edit_shoppers",
        label: "Edit Shoppers",
        description: "Can edit shopper details",
      },
      {
        key: "delete_shoppers",
        label: "Delete Shoppers",
        description: "Can delete shoppers",
      },
      {
        key: "view_shoppers",
        label: "View Shoppers",
        description: "Can view shopper listings",
      },
      {
    ...
    actions: [
      {
        key: "access",
        label: "Access Wallet",
        description: "Can access wallet page",
      },
      {
        key: "view_wallet",
        label: "View Wallet",
        description: "Can view wallet information",
      },
      {
        key: "add_funds",
        label: "Add Funds",
        description: "Can add funds to wallet",
      },
      {
        key: "remove_funds",
        label: "Remove Funds",
        description: "Can remove funds from wallet",
      },
      {
        key: "process_payout",
  ...
  refunds: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Refunds",
        description: "Can access refunds page",
      },
      {
        key: "view_refunds",
        label: "View Refunds",
        description: "Can view refund listings",
      },
      {
        key: "process_refunds",
        label: "Process Refunds",
      ...
      {
        key: "reject_refunds",
        label: "Reject Refunds",
        description: "Can reject refund requests",
      },
      {
        key: "export_refunds",
    ...
    actions: [
      {
        ...
        description: "Can access tickets page",
      },
      {
        key: "view_tickets",
        label: "View Tickets",
        description: "Can view ticket listings",
      },
      {
        key: "create_tickets",
      ...
      },
      {
        ...
        description: "Can export ticket data",
      },
    ],
  },
  help: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Help",
        description: "Can access help center",
      },
      {
  ...
  settings: {
    ...
    actions: [
      ...
      },
      {
        key: "manage_backup",
        label: "Manage Backup",
        description: "Can manage backup settings",
      },
    ],
  },
  promotions: {
    ...
    actions: [
      {
        ...
        description: "Can access promotions page",
      },
      {
        key: "view_promotions",
  ...
  referrals: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Referrals",
        description: "Can access referrals page",
      },
      {
        key: "view_data",
        label: "View Data",
        description: "Can view referral window data",
      },
      {
        key: "export_data",
        label: "Export Data",
        description: "Can export referral records",
      },
    ],
  },
  project_users: {
  ...
  restaurants: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Restaurants",
        description: "Can access restaurants page",
      },
      {
      ...
      },
      {
        ...
        description: "Can add new restaurants",
      },
      {
  ...
  recipes: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Recipes",
        description: "Can access recipes page",
      },
      {
        key: "view",
        label: "View Recipes",
        description: "Can view recipe details",
      },
      {
        key: "manage",
    ...
    actions: [
      {
        key: "access",
        label: "Access Orders",
        description: "Can access production orders",
      },
      {
        key: "view",
        label: "View Orders",
        description: "Can view production order status",
      },
      {
        key: "manage",
        label: "Manage Orders",
        description: "Can create and fulfill orders",
      },
    ],
  },
    ...
    actions: [
      {
        key: "access",
        label: "Access Dashboard",
        description: "Can access production dashboard",
      },
      {
        key: "view",
        label: "View Analytics",
        description: "Can view production metrics",
      },
    ],
  },
  cost_profit: {
    ...
    actions: [
      {
        ...
        description: "Can access cost & profit data",
      },
      {
        key: "view",
        label: "View Reports",
        description: "Can view financial production reports",
      },
    ],
  },
  simulate_stock: {
    ...
    actions: [
      {
        ...
        description: "Can access stock simulator",
      },
      {
        key: "view",
        label: "View Results",
        description: "Can view simulation outcomes",
      },
      {
        key: "run",
        label: "Run Simulation",
        description: "Can execute new simulations",
      },
    ],
  },
    ...
    actions: [
      {
        key: "access",
        label: "Access Dashboard",
        description: "Can access procurement dashboard",
      },
      {
        key: "view",
        label: "View Metrics",
        description: "Can view purchasing analytics",
      },
    ],
  },
  suppliers: {
    ...
    actions: [
      {
        ...
        description: "Can access suppliers page",
      },
      {
        key: "view",
        label: "View Suppliers",
        description: "Can view vendor details",
      },
      {
        key: "manage",
  ...
  quotations: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Quotations",
        description: "Can access quotations page",
      },
      {
        key: "view",
        label: "View Quotations",
        description: "Can view price quotes",
      },
      {
        key: "manage",
        label: "Manage Quotations",
        description: "Can create and compare quotes",
      },
    ],
  },
  purchase_orders: {
    ...
    actions: [
      {
        key: "access",
        label: "Access POs",
        description: "Can access purchase orders",
      },
    ...
    actions: [
      {
        key: "access",
        label: "Access Reels",
        description: "Can access reels management",
      },
      {
        key: "view",
        label: "View Reels",
        description: "Can view video content",
      },
      {
        key: "manage",
        label: "Manage Content",
        description: "Can upload and edit reels",
      },
    ],
  },
  point_of_sale: {
    ...
    actions: [
      {
        key: "access",
        label: "Access POS",
        description: "Can access the POS system",
      },
      {
        key: "park_sale",
        label: "Park Sale",
        description: "Can put sales on hold",
      },
      {
        key: "process_sale",
        label: "Process Sale",
        description: "Can complete transactions",
      },
    ],
  },
  pages: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Pages",
        description: "Can access pages management",
      },
    ],
  },
  plasmarket: {
    ...
    actions: [
      {
        ...
        description: "Can access influencers page",
      },
      {
        key: "view_earnings",
        label: "View Earnings",
        description: "Can view influencer earnings",
      },
      {
  ...
  withdraw_requests: {
    ...
    actions: [
      ...
      },
      {
        ...
        description: "Can approve withdraw requests",
      },
      {
        key: "reject",
        label: "Reject Requests",
        description: "Can reject withdraw requests",
      },
    ],
  },
  procurement: {
    ...
    actions: [
      ...
      },
      {
        key: "view_reports",
        label: "View Reports",
        description: "Can view procurement reports",
      },
    ],
  },
  production: {
    ...
    actions: [
      {
        key: "access",
        label: "Access Production",
        description: "Can access production module",
      },
      {
        key: "view_recipes",
        label: "View Recipes",
        description: "Can view recipe listings",
      },
      {
        key: "manage_recipes",
        label: "Manage Recipes",
    ...
    actions: [
      {
        key: "access",
        label: "Access Tax",
        description: "Can access tax module",
      },
      {
        key: "view_dashboard",
        label: "View Dashboard",
        description: "Can view tax dashboards",
      },
      {
      ...
      },
      {
        key: "export_reports",
        label: "Export Reports",
        description: "Can export tax reports",
      },
    ],
  },
  ai_chat: {
    ...
    group: "Engagement & CRM",
    description:
      "Access and utilize the AI assistant for reporting and queries",
    actions: [
      {
        key: "access",
        label: "Access AI Chat",
        description: "Can access the AI chat page",
      },
      {
        key: "use_chat",
        label: "Use Chat",
