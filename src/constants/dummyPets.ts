...
export const DUMMY_PETS: Pet[] = [
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1552053831-71594a27632d?q=80&w=2024&auto=format&fit=crop",
        label: "Front View",
      },
      {
    ...
    videoUrl:
      "https://assets.mixkit.co/videos/preview/mixkit-golden-retriever-puppy-running-in-the-grass-42410-large.mp4",
    parentImages: [
      {
    ...
    story:
      "Max is a playful and energetic puppy looking for a loving home. He loves playing fetch and is great with children.",
    likes: 24,
  ...
  },
  {
    ...
    story:
      "Luna is a calm and affectionate cat. She was rescued from the street and is now healthy and ready for her forever home.",
    likes: 12,
    location: "Musanze",
    isVaccinated: true,
    vaccinations: [
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1589941013453-ec89f33b5e95?q=80&w=1974&auto=format&fit=crop",
        label: "Standing",
      },
    ],
    parentImages: [
      {
        url: "https://images.unsplash.com/photo-1551730459-92db2a308d6a?q=80&w=1974&auto=format&fit=crop",
        label: "Parents",
      },
    ],
    story:
      "Charlie is a smart and brave puppy. He is already showing great guard dog potential.",
    likes: 45,
    location: "Rubavu",
    isVaccinated: true,
