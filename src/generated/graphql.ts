...
export type Orders = {
  ...
  delivery_notes: Scalars['String']['output'];
...
export type GetCartsQuery = { Carts: Array<{ id: string, user_id: string, total: string, created_at: string, updated_at: string }> };
...
export type GetShopsQuery = { Shops: Array<{ id: string, name: string, description: string, category_id: string, image: string, address: string, latitude: string, longitude: string, operating_hours: any, created_at: string, updated_at: string, is_active: boolean }> };
