...
export type GetShopperInformationQuery = { shoppers: Array<{ Employment_id: number, address: string, background_check_completed: boolean, created_at: string, driving_license: string, full_name: string, id: string, national_id: string, onboarding_step: string, phone_number: string, profile_photo: string, status: string, transport_mode: string, updated_at: string, user_id: string, active: boolean }> };
