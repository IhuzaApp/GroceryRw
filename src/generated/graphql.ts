...
export type GetInvoiceDetialsQuery = { Invoices: Array<{ created_at: string, customer_id: string, delivery_fee: string, discount: string, id: string, invoice_items: any, invoice_number: string, Proof?: string | null, order_id?: string | null, reel_order_id?: string | null, service_fee: string, status: string, subtotal: string, tax: string, total_amount: string, Order?: { combined_order_id?: string | null, created_at: string, delivery_address_id: string, delivery_fee: string, delivery_notes?: string | null, delivery_photo_url?: string | null, delivery_time?: string | null, discount?: string | null, found: boolean, id: string, service_fee: string, shop_id: string, shopper_id?: string | null, status: string, total: string, updated_at?: string | null, user_id: string, voucher_code?: string | null, OrderID: number, Order_Items: Array<{ created_at: string, id: string, order_id: string, price: string, product_id: string, quantity: number, Product: { barcode?: string | null, category: string, created_at: string, description: string, final_price?: string | null, id: string, image?: string | null, is_active: boolean, measurement_unit: string, name: string, price: string, quantity: number, reorder_point?: number | null, shop_id: string, sku?: string | null, supplier?: string | null, updated_at?: string | null } }> } | null, User: { created_at: string, email: string, gender: string, id: string, is_active: boolean, name: string, password_hash: string, phone: string, profile_picture?: string | null, role: string, updated_at?: string | null } }> };
...
export type GetShopsQuery = { Shops: Array<{ id: string, name: string, description: string, category_id: string, image: string, address: string, latitude: string, longitude: string, operating_hours: any, created_at: string, updated_at?: string | null, is_active: boolean, logo?: string | null, phone?: string | null }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getInvoiceDetials(variables?: GetInvoiceDetialsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetInvoiceDetialsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetInvoiceDetialsQuery>(GetInvoiceDetialsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getInvoiceDetials', 'query', variables);
    },
    ...
    getRestaurants(variables?: GetRestaurantsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRestaurantsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRestaurantsQuery>(GetRestaurantsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getRestaurants', 'query', variables);
    },
    getShopperDetails(variables?: GetShopperDetailsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetShopperDetailsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetShopperDetailsQuery>(GetShopperDetailsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getShopperDetails', 'query', variables);
    },
    ...
    UpdateShopperTelegramId(variables: UpdateShopperTelegramIdMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateShopperTelegramIdMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateShopperTelegramIdMutation>(UpdateShopperTelegramIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateShopperTelegramId', 'mutation', variables);
    },
    UpdateShopperStatus(variables: UpdateShopperStatusMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateShopperStatusMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateShopperStatusMutation>(UpdateShopperStatusDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateShopperStatus', 'mutation', variables);
    },
    GetShopperByTelegramId(variables: GetShopperByTelegramIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetShopperByTelegramIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetShopperByTelegramIdQuery>(GetShopperByTelegramIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetShopperByTelegramId', 'query', variables);
    },
    GetShopperByUserId(variables: GetShopperByUserIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetShopperByUserIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetShopperByUserIdQuery>(GetShopperByUserIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetShopperByUserId', 'query', variables);
    },
