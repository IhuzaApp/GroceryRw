 ...
 */
export function containsBlockedPii(text: string): PiiCheckResult {
...
export function getBlockedMessage(reason: "phone" | "email"): string {
  return reason === "phone"
    ? "Sharing phone numbers is not allowed in chat for security."
    : "Sharing email addresses is not allowed in chat for security.";
}
