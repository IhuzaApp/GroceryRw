    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="dark:hover:bg-gray-750 flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-gray-700 shadow-lg transition-all duration-300 hover:scale-[1.02] hover:border-gray-300 hover:bg-gray-50 hover:shadow-xl active:scale-[0.98] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:border-gray-600"
        >
          <svg
      ...
      <button
        ...
        className={`group flex items-center gap-2 rounded-xl border px-5 py-3 text-sm font-semibold shadow-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] ${
          isNearbyActive
            ...
            : "dark:hover:bg-gray-750 border-gray-200 bg-white text-gray-700 shadow-gray-200/50 hover:border-gray-300 hover:bg-gray-50 hover:shadow-xl dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:shadow-gray-900/50 dark:hover:border-gray-600"
        }`}
      >
        <svg
          className={`h-4 w-4 transition-transform duration-300 ${
            isNearbyActive ? "text-white" : "text-gray-600 dark:text-gray-300"
          }`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
