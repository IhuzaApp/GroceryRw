...
export const CategoryIcon = ({ category }: { category: string }) => {
  ...
  // Liquor SVG component (provided icon)
  const LiquorIcon = () => (
    <svg
      width="48px"
      height="48px"
    ...
    >
      ...
      ></g>
      <g id="SVGRepo_iconCarrier">
        <style type="text/css">{`.st0{fill:#a86200;}`}</style>
        <g>
          <polygon
            className="st0"
            points="430.357,0 81.626,0 74.37,49.369 437.621,49.369 "
          ></polygon>
          <polygon
            className="st0"
            points="81.626,512 430.357,512 437.621,462.631 74.37,462.631 "
          ></polygon>
          <path
            className="st0"
            d="M19.44,225.993v69.108H492.56v-69.108H19.44z M122.781,273.326c-7.05,0-12.783-5.716-12.783-12.783 c0-7.05,5.732-12.774,12.783-12.774c7.05,0,12.782,5.724,12.782,12.774C135.564,267.61,129.831,273.326,122.781,273.326z M258.037,273.326c-7.05,0-12.783-5.716-12.783-12.783c0-7.05,5.732-12.774,12.783-12.774c7.05,0,12.782,5.724,12.782,12.774 C270.819,267.61,265.086,273.326,258.037,273.326z M393.292,273.326c-7.05,0-12.783-5.716-12.783-12.783 c0-7.05,5.732-12.774,12.783-12.774c7.05,0,12.782,5.724,12.782,12.774C406.075,267.61,400.342,273.326,393.292,273.326z"
          ></path>
          <path
            className="st0"
            d="M266.798,308.261v145.01h101.065c10.901-42.627,18.498-91.884,21.784-145.01H266.798z"
          ></path>
          <path
            className="st0"
            d="M152.248,453.271h97.028v-145.01H130.498c2.721,44.158,8.368,85.69,16.496,122.918 C148.637,438.742,150.409,446.075,152.248,453.271z"
          ></path>
          <path
            className="st0"
            d="M390.212,434.917c-1.37,6.238-2.806,12.339-4.304,18.354h52.535c23.794-41.292,40.043-90.892,46.092-145.01 h-77.39C404.398,353.66,398.614,396.415,390.212,434.917z"
          ></path>
          <path
            className="st0"
            d="M112.89,308.261H27.448c6.058,54.118,22.297,103.718,46.1,145.01h60.646 C123.474,410.13,116.073,361.035,112.89,308.261z"
          ></path>
          <path
            className="st0"
            d="M408.3,212.826h77.005c-5.356-56.966-21.99-109.176-46.862-152.316h-48.908 C399.71,106.131,406.28,157.724,408.3,212.826z"
          ></path>
          <path
            className="st0"
            d="M249.276,212.826V60.51H148.484c-10.336,45.158-17.113,96.906-19.183,152.316H249.276z"
          ></path>
          <path
            className="st0"
            d="M371.542,60.51H266.798v152.316h123.918C388.74,160.129,382.598,110.7,373.1,67.132 C372.603,64.873,372.056,62.734,371.542,60.51z"
          ></path>
          <path
            className="st0"
            d="M129.874,63.401c0.214-0.984,0.463-1.916,0.676-2.891H73.549c-24.864,43.14-41.515,95.35-46.862,152.316h85.15 C113.823,158.922,120.078,108.278,129.874,63.401z"
          ></path>
        </g>
      </g>
    </svg>
