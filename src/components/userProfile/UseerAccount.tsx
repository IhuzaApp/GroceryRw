  ...
  return (
    <>
      ...
      <div className="block">
        ...
        <div className="mb-3 mt-8 rounded-xl border border-gray-200 bg-white px-6 pb-4 pt-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="rounded-xl border border-gray-200 bg-white px-6 pb-4 pt-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center">
