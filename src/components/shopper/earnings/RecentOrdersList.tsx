  ...
  return (
    <div className={`mt-8 border-t pt-4 ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}>
      <div className="mb-4 flex items-center justify-between">
        <h3 className={`font-medium ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Recent Orders</h3>
      ...
      {isLoading ? (
        ...
        <div className={`rounded-lg p-6 text-center ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`}>
          <p className={theme === "dark" ? "text-gray-400" : "text-gray-500"}>No recent orders found</p>
        </div>
      ) : (
