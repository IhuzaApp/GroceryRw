...
const EarningsComponentsCard: React.FC<EarningsComponentsCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute -bottom-20 -left-20 h-64 w-64 rounded-full blur-[100px] transition-all duration-700 group-hover:scale-110 ${
      ...
      <div className="relative z-10">
        ...
        {isLoading ? (
          ...
          <div className="space-y-8">
                ...
                <div key={index} className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`h-2.5 w-2.5 rounded-full shadow-[0_0_8px_rgba(0,0,0,0.1)] ${getDotsColor(
                          component.type
                        )}`}
                      />
                      <span
            ...
            <div
              className={`mt-10 overflow-hidden rounded-3xl transition-all duration-300 ${
                isDark
                  ? "border border-white/5 bg-gradient-to-br from-emerald-500/10 to-teal-500/5"
              ...
              <div className="relative p-6">
                <div className="absolute right-0 top-0 p-4 opacity-10">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10v2a2 2 0 002 2V6a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
          ...
          <div className="py-12 text-center">
            ...
            >
              <svg
                className="h-8 w-8 text-gray-400 opacity-20"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
