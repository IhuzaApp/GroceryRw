        ...
        >
          {[1, 2, 3].map((i) => (
            <div key={i} className="text-center">
              ...
              ></div>
              <div
                className={`mx-auto mb-1 h-4 w-6 ${
                  theme === "dark" ? "bg-gray-700" : "bg-gray-200"
                } rounded`}
              ></div>
              <div
                className={`mx-auto h-2 w-8 ${
                  theme === "dark" ? "bg-gray-700" : "bg-gray-200"
                } rounded`}
              ></div>
            </div>
            ...
            {pending.slice(0, 4).map((achievement, index) => (
              ...
              >
                <div className="relative">
                  <div className="mb-2 flex items-center justify-between">
                    <div className="flex min-w-0 flex-1 items-center gap-2">
                      <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-white/5 backdrop-blur-sm">
                        {getBadgeIcon(achievement.level)}
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="mb-1 flex items-center gap-1">
