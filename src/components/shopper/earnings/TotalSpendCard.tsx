          ...
          <div className="space-y-8">
            <div>
              <div className="flex items-baseline gap-1">
                <span className="bg-gradient-to-br from-teal-400 via-emerald-500 to-cyan-500 bg-clip-text text-5xl font-black tracking-tighter text-transparent sm:text-6xl">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div
                  className={`flex items-center gap-2 rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-widest ${
                    isDark
              ...
              <button
                className={`flex-1 rounded-2xl border px-4 py-3.5 text-[10px] font-black uppercase tracking-[0.2em] transition-all active:scale-95 ${
                  isDark
                    ...
                    : "border-gray-200 text-gray-500 shadow-sm hover:bg-gray-50 hover:text-gray-900"
                }`}
              >
                Snapshot
              </button>
