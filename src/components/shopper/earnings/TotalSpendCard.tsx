    ...
    <div
      className={`group relative overflow-hidden rounded-[2rem] p-6 transition-all duration-500 hover:shadow-2xl ${
        isDark
          ...
          : "border border-black/5 bg-white shadow-xl hover:shadow-teal-500/10"
      }`}
    >
      {/* Background Decorative Glow */}
      <div className="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-teal-500/10 opacity-50 blur-3xl transition-opacity group-hover:opacity-100" />
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <p className="text-xs font-bold opacity-40">Total lifetime</p>
              </div>
            </div>
