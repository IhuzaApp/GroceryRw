...
const PerformanceMetricsCard: React.FC<PerformanceMetricsCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute -bottom-20 -right-20 h-64 w-64 rounded-full blur-[100px] transition-all duration-700 group-hover:scale-110 ${
              ...
              <div key={index} className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-2 w-2 rounded-full shadow-[0_0_8px_rgba(0,0,0,0.1)] bg-${metric.accent}-500`}
                    />
                    <span
