...
const EarningsMobileMenu: React.FC<EarningsMobileMenuProps> = ({
  onSelect,
}) => {
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`group flex w-full items-center gap-4 rounded-[2rem] border p-5 transition-all duration-300 active:scale-[0.98] ${
                isDark
            ...
            >
              <div
                className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl transition-all duration-300 ${accentConfig}`}
              >
              ...
              <div className="opacity-30 transition-all duration-300 group-hover:opacity-100">
