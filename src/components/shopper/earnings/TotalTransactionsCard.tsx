          ...
          <div className="space-y-8">
            <div className="relative">
              <div className="flex items-baseline gap-1">
                <span className="bg-gradient-to-br from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-6xl font-black tracking-tighter text-transparent">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div
                className={`group/card rounded-3xl p-5 transition-all duration-300 ${
                  isDark
                    ? "border border-white/5 bg-white/[0.03] hover:bg-white/[0.05]"
                    : "border border-gray-100 bg-gray-50 hover:bg-gray-100"
                }`}
              >
                <p className="mb-1 text-[10px] font-black uppercase tracking-widest text-emerald-500/60">
                  Finalized
                </p>
                <p
                ...
                <div className="mt-2 h-1 w-8 rounded-full bg-emerald-500/30 transition-all duration-500 group-hover/card:w-full"></div>
              </div>
              ...
              >
                <p className="mb-1 text-[10px] font-black uppercase tracking-widest text-amber-500/60">
                  Queue
                </p>
                <p
                  className={`text-3xl font-black tracking-tight ${
                ...
                <div className="mt-2 h-1 w-8 rounded-full bg-amber-500/30 transition-all duration-500 group-hover/card:w-full"></div>
              </div>
            </div>
          </div>
        )}
