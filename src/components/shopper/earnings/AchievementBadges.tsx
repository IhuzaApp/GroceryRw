        ...
        return (
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              ></path>
              <path
                d="M20.5868 11.0621C20.5868 15.8422 16.7118 19.7172 11.9317 19.7172C7.15159 19.7172 3.27656 15.8422 3.27656 11.0621C3.27656 6.28205 7.15159 2.40702 11.9317 2.40702C16.7004 2.40702 20.5868 6.28205 20.5868 11.0621Z"
                fill="#C09525"
              ></path>
              <path
        ...
        return (
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <polygon
                style={{ fill: "#E68900" }}
                points="394.827,348.588 327.842,345.626 335.247,418.117 376.558,463.238 443.254,465.502"
              ></polygon>
              <polygon
                style={{ fill: "#FFAD00" }}
                points="285.067,401.113 330.999,512 376.558,463.238 327.842,345.626"
              ></polygon>
              <polygon
                style={{ fill: "#E68900" }}
                points="231.519,395.086 186.248,345.626 140.225,402.122 137.532,463.238 183.091,512"
              ></polygon>
              <polygon
                style={{ fill: "#FFAD00" }}
                points="119.26,348.593 70.836,465.502 137.532,463.238 186.248,345.626"
              ></polygon>
              <path
                style={{ fill: "#FFCE2A" }}
                d="M254.955,0l-20.899,201.532l20.899,201.531c111.303,0,201.532-90.229,201.532-201.532 S366.258,0,254.955,0z"
              ></path>
              <path
                style={{ fill: "#FDEB95" }}
                d="M55.513,201.532c0,111.303,90.229,201.532,201.532,201.532V0C145.742,0,55.513,90.229,55.513,201.532 z"
              ></path>
              <path
                style={{ fill: "#E68900" }}
                d="M257.045,45.098l-20.899,156.434l20.899,156.433c86.258,0,156.434-70.175,156.434-156.434 C413.479,115.273,343.303,45.098,257.045,45.098z"
              ></path>
              <path
                style={{ fill: "#FFAD00" }}
                d="M100.611,201.531c0,86.258,70.175,156.434,156.434,156.434V45.098 C170.786,45.098,100.611,115.273,100.611,201.531z"
              ></path>
              <path
                style={{ fill: "#6CD800" }}
                d="M315.279,162.202c-6.013,0-14.11,1.354-22.672,3.768c2.413-8.562,3.768-16.659,3.768-22.672 c0-21.721-17.609-39.329-39.329-39.329l-22.077,97.564l22.076,97.562c21.721,0,39.329-17.609,39.329-39.329 c0-6.013-1.354-14.11-3.768-22.672c8.562,2.413,16.659,3.768,22.672,3.768c21.721,0,39.33-17.609,39.33-39.329 C354.609,179.81,337,162.202,315.279,162.202z"
              ></path>
              <path
                style={{ fill: "#93F340" }}
                d="M217.716,143.296c0,6.013,1.354,14.11,3.768,22.672c-8.562-2.413-16.659-3.768-22.672-3.768 c-21.721,0-39.33,17.609-39.33,39.33s17.609,39.329,39.33,39.329c6.013,0,14.11-1.354,22.672-3.768 c-2.413,8.562-3.768,16.659-3.768,22.672c0,21.721,17.609,39.329,39.329,39.329V103.967 C235.324,103.967,217.716,121.576,217.716,143.296z"
              ></path>
            </g>
          </svg>
        );
  ...
  if (loading) {
    return (
      <div className="w-full">
        ...
        <div
          className={`mb-6 grid grid-cols-3 gap-2 rounded-2xl p-4 sm:gap-4 sm:p-6 ${
        ...
        >
          {[1, 2, 3].map((i) => (
            <div key={i} className="text-center">
              <div
                className={`mx-auto mb-2 h-12 w-12 rounded-full sm:h-16 sm:w-16 ${
                  theme === "dark" ? "bg-gray-700" : "bg-gray-200"
                }`}
              ></div>
              <div
                className={`mx-auto mb-1 h-6 w-8 ${
                  theme === "dark" ? "bg-gray-700" : "bg-gray-200"
                } rounded`}
              ></div>
              <div
    ...
    <div className="w-full">
      ...
      <div
        className={`mb-6 grid grid-cols-3 gap-2 rounded-2xl p-4 sm:gap-4 sm:p-6 ${
          theme === "dark"
            ...
            : "border border-gray-200 bg-gradient-to-r from-white to-gray-50"
        } shadow-lg`}
      >
        <div className="text-center">
          <div
            className={`mb-2 inline-flex h-12 w-12 items-center justify-center rounded-full sm:h-16 sm:w-16 ${
          ...
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="h-6 w-6 text-green-500 sm:h-8 sm:w-8"
            >
        ...
        <div className="text-center">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="h-6 w-6 text-orange-500 sm:h-8 sm:w-8"
            >
        ...
        <div className="text-center">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="h-6 w-6 text-purple-500 sm:h-8 sm:w-8"
            >
              <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
            </svg>
          </div>
          <div className="text-lg font-bold text-purple-500 sm:text-2xl">
            {achieved.length + pending.length}
          </div>
          <div
            className={`text-xs font-medium sm:text-sm ${
              theme === "dark" ? "text-gray-300" : "text-gray-600"
            ...
            {achieved.map((achievement, index) => (
              <div
                ...
                className={`relative overflow-hidden rounded-2xl p-4 sm:p-5 ${
                  theme === "dark"
                    ? "border border-green-500/30 bg-gradient-to-r from-green-900/30 to-emerald-900/20"
                ...
                <div className="relative">
                  <div className="mb-3 flex items-center justify-between">
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white/10 backdrop-blur-sm sm:h-14 sm:w-14">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        >
                          {formatCurrentValue(achievement)} /{" "}
                          {formatTargetValue(achievement)}
                        </div>
                      </div>
                    </div>
                    <div
                  ...
                  {achievement.streakCount && achievement.streakCount > 1 && (
                    ...
                    >
                      <span className="flex items-center">
                        {getStreakIcon(achievement.streakCount)}
                      </span>
          ...
          <div className="space-y-3">
            {pending.slice(0, 6).map((achievement, index) => (
              <div
                ...
                className={`relative overflow-hidden rounded-2xl p-4 sm:p-5 ${
                  theme === "dark"
                    ? "border border-gray-600/50 bg-gradient-to-r from-gray-800/50 to-gray-700/50"
                    : "border border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100"
                } shadow-lg`}
              >
                <div className="relative">
                  <div className="mb-3 flex items-center justify-between">
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm sm:h-14 sm:w-14">
                        {getBadgeIcon(achievement.level)}
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="mb-1 flex items-center gap-2">
      ...
      {achieved.length === 0 && pending.length === 0 && (
        <div className="flex flex-col items-center justify-center px-4 py-12 text-center sm:py-16">
          ...
          >
            <div className="mb-2 text-6xl sm:text-7xl">🏆</div>
            <div className="absolute -right-1 -top-1 h-4 w-4 animate-pulse rounded-full bg-yellow-400"></div>
          </div>
          <h4
          ...
          >
            Complete orders, earn great ratings, and reach monthly targets to
            unlock your first achievement badges!
          </p>
          <div
            className={`mt-6 rounded-full px-6 py-3 ${
              theme === "dark"
                ? "border border-yellow-500/30 bg-gradient-to-r from-yellow-500/20 to-orange-500/20"
                : "border border-yellow-200 bg-gradient-to-r from-yellow-100 to-orange-100"
            }`}
          >
            <span
