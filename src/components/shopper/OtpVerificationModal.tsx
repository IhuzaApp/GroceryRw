...
const OtpVerificationModal: React.FC<OtpVerificationModalProps> = ({
  ...
  return (
    <Modal open={open} onClose={onClose} size="xs">
      <Modal.Header>
        <Modal.Title className="text-xl font-bold">Secure Verification</Modal.Title>
      </Modal.Header>
      <Modal.Body>
          ...
          <div className="rounded-xl bg-blue-50 p-4 dark:bg-blue-900/20">
            <div className="flex gap-3">
              ...
              <div className="text-xs text-blue-800 dark:text-blue-300">
                ...
                <p className="mt-1">Check your network connection or try requesting a new code after 60 seconds.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <Modal.Footer className="flex justify-center gap-2 border-t pt-4">
        ...
        <Button onClick={onClose} appearance="subtle" className="w-full rounded-xl py-2.5">
          Cancel
        </Button>
      </Modal.Footer>
    </Modal>
