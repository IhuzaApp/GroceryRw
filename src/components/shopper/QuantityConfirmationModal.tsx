...
export default function QuantityConfirmationModal({
  ...
  return (
    ...
    >
      <Modal.Header className={`${theme === "dark" ? "bg-gray-800" : "bg-white"} border-b border-slate-200 dark:border-slate-700`}>
        <Modal.Title className={`text-lg font-semibold ${theme === "dark" ? "text-gray-100" : "text-gray-900"}`}>
          Confirm Found Quantity
        </Modal.Title>
      </Modal.Header>
      
      <Modal.Body className={`${theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-white text-gray-900"} p-6`}>
        {/* Product Info Card */}
        <div className={`mb-6 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800`}>
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className={`text-base font-semibold ${theme === "dark" ? "text-gray-100" : "text-gray-900"}`}>
        ...
        <div className="space-y-4">
          <div className={`rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-600 dark:bg-slate-700`}>
            <div className="mb-3">
