...
const ORDER_TYPES = [
  {
    value: "regular",
    label: "Regular",
    desc: "Standard grocery order",
    dot: "bg-emerald-400",
  },
  {
    value: "reel",
    label: "Reel",
    desc: "Reel-based order",
    dot: "bg-violet-400",
  },
  {
    value: "restaurant",
    label: "Restaurant",
    desc: "Restaurant food order",
    dot: "bg-orange-400",
  },
  {
    value: "business",
    label: "Business",
    desc: "Business bulk order",
    dot: "bg-blue-400",
  },
  {
    value: "store",
    label: "Store",
    desc: "Store pickup order",
    dot: "bg-teal-400",
  },
  {
    value: "plasone",
...
const STATUS_LIST = [
  {
    value: "accepted",
    label: "Accepted",
    desc: "Shopper accepted",
    dot: "bg-emerald-400",
  },
  {
    value: "picked",
    label: "Picked Up",
    desc: "Items picked from store",
    dot: "bg-orange-400",
  },
  {
    value: "shopping",
  ...
  },
  {
    value: "on_the_way",
    label: "On The Way",
    desc: "En route to customer",
    dot: "bg-purple-400",
  },
  {
    value: "at_customer",
    label: "At Customer",
    desc: "At delivery location",
    dot: "bg-indigo-400",
  },
  {
    value: "delivered",
...
const URGENCY_LIST = [
  {
    ...
    desc: "Just accepted batches",
    dot: "bg-blue-400",
  },
  {
    value: "late",
    label: "Late",
    desc: "Past delivery time",
    dot: "bg-red-400",
  },
  {
    value: "urgent",
    label: "Urgent",
    desc: "Less than 10 minutes left",
    dot: "bg-orange-400",
  },
  {
    value: "okay",
    label: "On Track",
    desc: "No immediate rush",
    dot: "bg-emerald-400",
  },
];
      ...
      <div className="flex flex-1 items-center gap-2 sm:min-w-[220px] sm:max-w-sm">
        ...
        {onRefresh && (
          <button
            ...
            className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl transition-all duration-200 hover:-translate-y-px hover:shadow-md active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            style={{
              background: isDark
                ? "rgba(255,255,255,0.05)"
                : "rgba(0,0,0,0.04)",
