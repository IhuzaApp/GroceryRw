...
export default function ProgressStepsSection({
  ...
  const activeSteps = isReelOrRestaurantOrBusiness
    ? simplifiedSteps
    : regularSteps;

  return (
    <div
      className={`hidden overflow-hidden rounded-2xl border transition-all duration-300 sm:block ${
    ...
    >
      ...
      <div className="p-8">
        <div className="relative flex items-center justify-between">
          ...
          <div
            className={`absolute left-0 top-[1.1rem] h-[2px] w-full -translate-y-1/2 ${
          ...
          <div
            className="absolute left-0 top-[1.1rem] h-[2px] -translate-y-1/2 bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)] transition-all duration-700"
            style={{
            ...
            return (
              ...
              >
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full border-2 transition-all duration-500 ${
                    isCompleted
                      ...
                      : isCurrent
                      ? `scale-110 border-emerald-500 bg-[var(--bg-primary)] text-emerald-500 shadow-xl shadow-emerald-500/20`
                      : `bg-[var(--bg-primary)] ${
                          isDark
                ...
                <div className="mt-3 flex flex-col items-center">
                  ...
                  <span
                    className={`mt-0.5 whitespace-nowrap text-[10px] opacity-60 ${
