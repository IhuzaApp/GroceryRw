    ...
    return (
      <div>
        <div className="mb-3 flex items-center gap-2 px-3 sm:mb-4 sm:gap-3 sm:px-0">
          <div className="h-5 w-24 skeleton sm:h-6 sm:w-28" />
        </div>
        <div className="space-y-4 rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/30 sm:p-6">
          <div className="h-4 w-48 skeleton" />
          <div className="space-y-2 sm:space-y-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-3 dark:border-slate-600 dark:bg-slate-800 sm:gap-4 sm:p-4">
                <div className="h-12 w-12 flex-shrink-0 rounded-lg skeleton sm:h-14 sm:w-14" />
                <div className="min-w-0 flex-1">
                  <div className="mb-1 h-5 w-3/4 skeleton sm:h-6" />
                  <div className="mb-1 h-4 w-1/2 skeleton sm:h-5" />
                  <div className="h-4 w-20 skeleton sm:h-5" />
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="h-8 w-8 rounded skeleton sm:h-9 sm:w-9" />
                </div>
              </div>
            ))}
          </div>
