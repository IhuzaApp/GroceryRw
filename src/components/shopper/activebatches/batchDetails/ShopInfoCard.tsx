        ...
        {order.orderType === "reel" ? (
          <div className="space-y-5 p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-xs font-medium leading-relaxed text-gray-500 opacity-60 dark:text-gray-400">
                  {order.reel?.description}
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  <span
                    className={`rounded-lg px-2.5 py-1 text-[9px] font-black uppercase tracking-widest ${
                      isDark
          ...
          <div className="divide-y divide-gray-100 dark:divide-white/5">
            {uniqueShops.map((shop, index) => (
              <div key={shop.id || index} className="space-y-5 p-5">
                <div className="flex items-start gap-4">
                  <div
                    className={`relative h-14 w-14 flex-shrink-0 rounded-xl border-2 p-0.5 ${
                      isDark
                        ? "border-white/10 bg-white/5"
                        : "border-black/5 bg-gray-50"
                    }`}
                      ...
                      <span className="text-xs font-bold text-gray-700 dark:text-gray-300">
                        {(() => {
                          const dayKey = new Date()
                            ...
                            .toLowerCase();
                          return (
                            (shop.operating_hours as any)[dayKey] || "Open Now"
                          );
                        })()}
                      </span>
                    </div>
