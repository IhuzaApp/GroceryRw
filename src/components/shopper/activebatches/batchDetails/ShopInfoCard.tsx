            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <span
                    className={`rounded-lg px-2.5 py-1 text-[10px] font-bold uppercase tracking-tight ${
                      isDark
            ...
            {(order.reel?.Restaurant || order.reel?.Shops) && (
              ...
              >
                {order.reel?.Restaurant ? (
                  <>
                    <p className="text-sm font-black uppercase tracking-tight text-gray-900 dark:text-gray-100">
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {shop.address && (
                      <p className="mt-1 text-xs leading-relaxed tracking-tight text-gray-500">
                        {shop.address}
                      </p>
                    )}
                    {shop.category && (
                ...
                >
                  {shop.phone && String(shop.phone).trim() && (
                    <div className="flex flex-col">
                      ...
                      <a
                        href={`tel:${shop.phone}`}
                        className="mt-0.5 text-xs font-bold text-emerald-600 dark:text-emerald-400"
                      >
                        {shop.phone}
                      </a>
                    </div>
                  ...
                  {shop.operating_hours && (
                    <div className="flex flex-col">
                      ...
                      <span className="mt-0.5 truncate text-xs font-bold text-gray-700 dark:text-gray-300">
                        {(() => {
                          const now = new Date();
                          const dayKey = now
                            ...
                            .toLowerCase();
                          return (
                            (shop.operating_hours as any)[dayKey] || "Open"
                          );
                        })()}
                      </span>
                    </div>
                ...
                {shop.address && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-3 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-emerald-500/20 transition-all hover:scale-[1.02] hover:bg-emerald-700 active:scale-[0.98]"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
