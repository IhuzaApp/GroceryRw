      ...
      return (
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            <svg className="h-4 w-4 flex-shrink-0 text-red-500 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span className="text-sm font-semibold text-red-600 dark:text-red-400">{overdueText}</span>
          </div>
        </div>
      );
    }
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <a
                      ...
                      className="flex items-center gap-2 text-sm hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
                    >
                      <svg className="h-4 w-4 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <td className="px-6 py-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-sm max-w-[200px] hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
                    ...
                    >
                      ...
                      <span className="truncate hover:underline">{order.customerAddress}</span>
                    </a>
                  </td>
                  <td className="px-6 py-4">
                    ...
                    <div className="relative">
                      ...
                      {openDropdownId === order.id && (
                        <div
                          ...
                          className={`w-56 rounded-lg shadow-lg z-[9999] ${
                            theme === "dark"
                        ...
                        >
                          <div className="py-1">
                            ...
                            {order.status === "accepted" && (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  alert(`Start shopping for order #${order.OrderID}`);
                                  setOpenDropdownId(null);
                                }}
                              >
                            ...
                            {/* Confirm Delivery */}
                            {(order.status === "shopping" || order.status === "on_the_way" || order.status === "at_customer") && (
                              <>
                                {order.invoiceUrl ? (
                                  <button
                                    className={`flex items-center gap-3 px-4 py-3 text-sm w-full text-left transition-colors ${
                                    ...
                                    onClick={() => {
                                      ...
                                      alert(`Confirm delivery for order #${order.OrderID}`);
                                      setOpenDropdownId(null);
                                    }}
                                  >
                                  ...
                                  <div
                                    className={`flex items-start gap-3 px-4 py-3 text-sm cursor-not-allowed opacity-60 ${
                                  ...
                                  >
                                    ...
                                    <div className="flex flex-col">
                                      <span>Confirm Delivery</span>
                                      <span className="text-xs mt-0.5 text-red-500 dark:text-red-400">Invoice required</span>
                                    </div>
                                  </div>
                                )}
                              </>
