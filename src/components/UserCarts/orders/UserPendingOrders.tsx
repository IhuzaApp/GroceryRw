...
<>
      ...
      <div className="custom-steps-wrapper">
        <Steps current={getStatusStep(order.status)} className="custom-steps" vertical={isMobile}>
  ...
  <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-4 gap-4">
    ...
    {order.status === "delivered" ? (
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
        <Button
          appearance="ghost"
          className="bg-green-500 text-white hover:bg-green-600 transition flex items-center justify-center"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
            ...
            <Modal.Body>
              <div className="text-center mb-6">
                ...
                <div className="flex justify-center">
                  <Rate color="yellow" size="lg" value={rating} onChange={setRating} />
                </div>
              </div>
              <div className="mb-4">
                <label className="block rounded-md text-sm text-gray-600 mb-2">Additional Comments</label>
                <textarea placeholder="Tell us more about your experience..." name="" id="" rows={4}></textarea>
              </div>
            </Modal.Body>
            <Modal.Footer>
