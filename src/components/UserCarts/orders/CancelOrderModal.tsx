  ...
  const modalContent = (
    <div className="fixed inset-0 z-[999999] flex items-end justify-center bg-black/70 p-0 backdrop-blur-md sm:items-center sm:p-4">
      <div
        ...
        } translate-y-0 transform opacity-100 transition-all sm:border`}
      >
        ...
        <div className="flex flex-col items-center px-8 pb-10 pt-2">
          ...
          <div className="relative mb-6">
            ...
            <div
              className={`relative flex h-20 w-20 items-center justify-center rounded-full shadow-inner ${
                isDark ? "bg-red-900/30 text-red-500" : "bg-red-50 text-red-500"
              }`}
            >
          ...
          <div
            className={`mb-8 flex w-full flex-col gap-3 rounded-2xl border p-5 ${
              isDark
          ...
          {order?.status?.toUpperCase() === "ACCEPTED" && (
            <div
              className={`mb-8 w-full overflow-hidden rounded-2xl border p-4 backdrop-blur-sm ${
                isDark
                ...
                <div>
                  ...
                  <p
                    className={`mt-1 text-xs leading-relaxed ${
                      isDark ? "text-orange-400/80" : "text-orange-700/80"
                    }`}
                  >
                    Since the order has been accepted, 30% of fees will be
                    retained as compensation. The remainder will be refunded
          ...
          <div className="flex w-full flex-col gap-3">
            <button
              ...
              className={`flex w-full items-center justify-center gap-2 rounded-2xl py-4 text-sm font-black shadow-xl transition-all active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 ${
                isDark
