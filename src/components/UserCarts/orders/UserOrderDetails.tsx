            ...
            <div className={`rounded-xl p-6 text-center transition-all ${
              ...
              <div className="flex justify-center mb-4">
                <Rate
                  ...
                  value={rating}
                  onChange={setRating}
                  color={rating > 3 ? "green" : rating > 0 ? "yellow" : undefined}
                  size="lg"
                  className="text-4xl"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  className={`w-full rounded-lg p-4 text-sm transition-all ${
                    theme === "dark"
                      ? "bg-gray-800 border-gray-600 text-white placeholder-gray-400 focus:border-green-500 focus:ring-green-500/50"
