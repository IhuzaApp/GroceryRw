  ...
  return (
    <div className="mx-auto max-w-2xl pb-32">
      ...
      <div className="space-y-8 duration-500 animate-in fade-in slide-in-from-bottom-4">
          ...
          <div className="space-y-6">
            ...
            <FormSection title="Their Story" icon={<Dog />} theme={theme}>
              <textarea
                ...
                className={`min-h-[150px] w-full rounded-[2rem] border p-6 text-sm font-bold outline-none transition-all ${
                  theme === "dark"
                    ? "border-white/10 bg-white/5 text-white focus:border-green-500/50"
                    : "border-gray-100 bg-gray-50 text-gray-900 focus:border-green-500"
                }`}
        ...
        {step === 3 && (
          <div className="space-y-6">
            <FormSection
              ...
              theme={theme}
            >
              <div className="mb-6 flex items-center justify-between rounded-2xl border border-green-500/10 bg-green-500/5 p-4">
                ...
                <button
                  ...
                  className={`relative h-6 w-12 rounded-full transition-all ${
                    formData.isVaccinated ? "bg-green-500" : "bg-gray-300"
                  }`}
                >
                  <div
                    className={`absolute top-1 h-4 w-4 rounded-full bg-white transition-all ${
                      formData.isVaccinated ? "left-7" : "left-1"
                    }`}
                  />
                </button>
              </div>
            ...
            {formData.ageInMonths < 6 && (
              ...
              >
                <p className="mb-4 text-[10px] uppercase tracking-widest text-gray-500">
                  Since the pet is under 6 months, please add photos of the
                  parents.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div
        ...
        {/* Footer Navigation */}
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-100 bg-white/80 p-6 backdrop-blur-md dark:border-white/5 dark:bg-[#121212]/80">
          <div className="mx-auto flex max-w-2xl gap-4">
            ...
            {step < totalSteps ? (
              <button
                type="button"
                onClick={handleNext}
                className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-green-500 py-4 font-black text-white shadow-xl shadow-green-500/20"
              >
                Continue
  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center gap-3">
        ...
        <h3 className="font-outfit text-lg font-black uppercase tracking-wider">
          {title}
        </h3>
      </div>
      {children}
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <select
        ...
        className={`rounded-2xl border px-5 py-4 text-sm font-bold outline-none transition-all ${
          theme === "dark"
            ? "border-white/10 bg-[#1A1A1A] text-white focus:border-green-500/50"
            : "border-gray-100 bg-gray-50 text-gray-900 focus:border-green-500"
        }`}
      >
