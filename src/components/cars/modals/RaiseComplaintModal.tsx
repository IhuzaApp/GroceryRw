...
export default function RaiseComplaintModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      />
      <div
        className={`relative w-full max-w-lg overflow-hidden rounded-[2.5rem] border ${
          theme === "dark"
      ...
      >
        ...
        <h3 className="mb-2 font-outfit text-2xl font-black">
          Raise Damage Complaint
        </h3>
        <p className="mb-8 text-sm text-gray-500">
          Report vehicle damage or issues discovered upon return. This will hold
          the security deposit for review.
        </p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full rounded-2xl border px-4 py-3 text-sm transition-all focus:ring-2 focus:ring-orange-500/20 ${
                theme === "dark"
          ...
          <div>
            ...
            <textarea
              ...
              className={`h-32 w-full resize-none rounded-2xl border px-4 py-3 text-sm transition-all focus:ring-2 focus:ring-orange-500/20 ${
                theme === "dark"
                  ? "border-white/10 bg-white/5"
                  : "border-gray-200 bg-gray-50"
              }`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-2xl border py-3 pl-14 pr-4 text-sm transition-all focus:ring-2 focus:ring-orange-500/20 ${
                  theme === "dark"
                    ? "border-white/10 bg-white/5"
                    : "border-gray-200 bg-gray-50"
                }`}
