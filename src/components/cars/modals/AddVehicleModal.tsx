...
export default function AddVehicleModal({ isOpen, onClose, theme, onSubmit }: AddVehicleModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center sm:p-6">
      ...
      <form 
        ...
        <div className="flex items-center justify-between p-8 pb-6 border-b border-gray-100 dark:border-white/5 shrink-0">
          <div>
            <h2 className="text-3xl font-black tracking-tight font-outfit">Add Vehicle</h2>
            <p className="text-xs font-black text-gray-400 uppercase tracking-widest mt-1">List a new car in your fleet</p>
          </div>
          <button 
            type="button"
            onClick={onClose}
