...
export const DashboardGrid: React.FC<DashboardGridProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <button
        onClick={onAddStock}
        className="group flex flex-col items-center justify-center gap-4 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all 
      ...
      <button
        ...
        className="group col-span-2 flex flex-col items-center justify-center gap-4 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all 
          hover:border-gray-200 hover:shadow-md active:scale-[0.98] 
          dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-800/80"
      >
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-400 to-green-700 text-white shadow-lg shadow-green-500/30 transition-transform group-hover:scale-110">
