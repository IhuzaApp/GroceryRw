...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  const inputClasses = "w-full rounded-2xl border-none bg-gray-50 py-5 pl-5 pr-12 text-lg font-bold shadow-sm transition focus:ring-2 focus:ring-green-500 dark:bg-gray-800";

  return (
    <form onSubmit={onSubmit} className="space-y-4 duration-500 animate-in fade-in slide-in-from-bottom-4 text-gray-900 dark:text-white">
      <div className="relative z-10">
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div className="absolute left-0 top-[calc(100%+4px)] z-50 w-full overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl duration-300 animate-in fade-in slide-in-from-top-2 dark:border-gray-700 dark:bg-gray-800">
            <div className="bg-gray-50/50 px-4 py-2 dark:bg-gray-900/50 text-left">
