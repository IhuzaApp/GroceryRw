                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div className="flex-1 space-y-3 sm:space-y-4">
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                        ...
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-[9px] font-bold sm:px-2.5 sm:text-[10px] ${
                            rfq.status === "Open"
                      ...
                      <p className="line-clamp-2 text-xs font-medium text-gray-900 dark:text-gray-400 sm:line-clamp-none">
                        {rfq.description}
                      </p>
                      <div className="flex flex-col gap-2 text-[11px] sm:flex-row sm:items-center sm:gap-6 sm:text-xs">
                        <span className="flex items-center gap-1.5 font-medium text-gray-900 dark:text-gray-400">
                          ...
                          <span className="font-bold">{rfq.budget}</span>
                        </span>
                        <span className="flex items-center gap-1.5 font-medium text-gray-900 dark:text-gray-400">
                    ...
                    <div className="flex flex-col gap-2 border-t border-gray-200 pt-3 dark:border-gray-700 sm:ml-6 sm:flex-row sm:border-0 sm:pt-0">
                      <button
                        onClick={() => handleViewResponses(rfq.id)}
                        className="flex-1 rounded-xl border-2 border-gray-200 px-2.5 py-1.5 text-[11px] font-medium text-gray-700 transition-all duration-300 hover:border-green-500 hover:bg-gray-50 active:scale-95 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700 sm:flex-none sm:px-3 sm:py-2 sm:text-xs"
                      >
