      ...
      >
        {loading ? (
          <div className="relative">
            ...
            <div className="fixed right-4 top-4 z-[10002] h-10 w-10 animate-pulse rounded-lg bg-gray-200 dark:bg-gray-700"></div>

            {/* Paper-like Contract Document Skeleton */}
            <div className="mx-auto max-w-4xl bg-[#faf9f6] px-3 py-6 shadow-2xl dark:bg-[#1a1814] sm:px-6 sm:py-8 md:px-16 md:py-16">
              {/* Document Header Skeleton */}
              <div className="mb-6 animate-pulse text-center sm:mb-8">
                <div className="mx-auto mb-2 h-8 w-3/4 rounded bg-gray-300 dark:bg-gray-700 sm:h-10 md:h-12"></div>
                <div className="mx-auto h-4 w-1/3 rounded bg-gray-200 dark:bg-gray-600"></div>
              </div>

              {/* Contract Tracking Info Skeleton */}
              <div className="mb-6 animate-pulse border-b-2 border-gray-300 pb-3 dark:border-gray-600 sm:mb-8 sm:pb-4">
                <div className="mb-2 h-3 w-2/3 rounded bg-gray-200 dark:bg-gray-600"></div>
                <div className="h-3 w-1/2 rounded bg-gray-200 dark:bg-gray-600"></div>
              </div>
              ...
              <div className="mb-6 animate-pulse space-y-6 sm:mb-8">
                <div>
                  <div className="mb-3 h-5 w-48 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div className="ml-2 space-y-2 sm:ml-4">
                    ...
                    <div className="h-3 w-3/5 rounded bg-gray-200 dark:bg-gray-600"></div>
                  </div>
                </div>
                <div>
                  <div className="mb-3 h-5 w-40 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div className="ml-2 space-y-2 sm:ml-4">
                    <div className="h-3 w-full rounded bg-gray-200 dark:bg-gray-600"></div>
                    <div className="h-3 w-4/5 rounded bg-gray-200 dark:bg-gray-600"></div>
                    <div className="h-3 w-3/5 rounded bg-gray-200 dark:bg-gray-600"></div>
              ...
              {/* Signatures Section Skeleton */}
              <div className="mt-8 animate-pulse space-y-8 border-t-2 border-gray-300 pt-6 dark:border-gray-600 sm:mt-12 sm:pt-8">
                <div className="grid grid-cols-1 gap-8 sm:gap-12 md:grid-cols-2 md:gap-16">
                  <div className="space-y-4">
                    ...
                    <div className="h-16 w-full rounded bg-gray-200 dark:bg-gray-600"></div>
                    <div className="space-y-2">
                      <div className="h-3 w-3/4 rounded bg-gray-200 dark:bg-gray-600"></div>
                      <div className="h-3 w-1/2 rounded bg-gray-200 dark:bg-gray-600"></div>
                    </div>
                  </div>
                  <div className="space-y-4">
              ...
              <div className="mt-8 flex flex-col gap-2 border-t-2 border-gray-300 pt-6 dark:border-gray-600 sm:mt-12 sm:flex-row sm:justify-end sm:gap-3 sm:pt-8">
                <div className="h-10 w-full rounded-lg bg-gray-200 dark:bg-gray-600 sm:w-32"></div>
                <div className="h-10 w-full rounded-lg bg-gray-200 dark:bg-gray-600 sm:w-24"></div>
              </div>
            </div>
          </div>
        ) : contract ? (
          <div className="relative">
            ...
            <div className="mx-auto max-w-4xl bg-[#faf9f6] px-3 py-6 shadow-2xl dark:bg-[#1a1814] sm:px-6 sm:py-8 md:px-16 md:py-16">
              ...
              <div className="mb-6 text-center sm:mb-8">
                <h1 className="mb-2 text-xl font-bold text-gray-900 dark:text-white sm:text-2xl md:text-3xl lg:text-4xl">
              ...
              <div className="mb-6 space-y-4 sm:mb-8 sm:space-y-6">
                <div>
                  <h2 className="mb-2 text-sm font-bold text-gray-900 dark:text-white sm:mb-3 sm:text-base md:text-lg">
              ...
              {/* Contract Sections */}
              <div className="space-y-4 text-[11px] leading-relaxed text-gray-800 dark:text-gray-200 sm:space-y-6 sm:text-xs md:text-sm">
                {/* Section 1: Purpose */}
                <div>
                  <h3 className="mb-1.5 text-xs font-bold text-gray-900 dark:text-white sm:mb-2 sm:text-sm md:text-base">
                ...
                {contract.specialConditions && (
                  <div>
                    ...
                    <p className="ml-2 break-words text-[11px] leading-relaxed text-gray-800 dark:text-gray-200 sm:ml-4 sm:text-xs md:text-sm">
                      {contract.specialConditions}
                    </p>
                  </div>
                )}
                ...
                {/* Signatures Section */}
                <div className="mt-8 space-y-8 border-t-2 border-gray-300 pt-6 dark:border-gray-600 sm:mt-12 sm:space-y-12 sm:pt-8">
                  <div className="grid grid-cols-1 gap-8 sm:gap-12 md:grid-cols-2 md:gap-16">
                    {/* Supplier Signature */}
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      {contract.supplierSignature ? (
                        ...
                        <div className="mb-4 h-16 sm:mb-6 sm:h-20"></div>
                      )}
              ...
              <div className="mt-8 flex flex-col gap-2 border-t-2 border-gray-300 pt-6 dark:border-gray-600 sm:mt-12 sm:flex-row sm:justify-end sm:gap-3 sm:pt-8">
                {isSupplier && contract.status === "waiting_for_supplier" && (
                  <button
                    ...
                    disabled={accepting}
                    className="flex items-center justify-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-green-700 disabled:opacity-50 dark:bg-green-700 dark:hover:bg-green-800 sm:px-6 sm:py-3 sm:text-base"
                  >
                    {accepting ? (
                      <>
                ...
                {contract.status === "active" && (
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-700 disabled:opacity-50 dark:bg-blue-700 dark:hover:bg-blue-800 sm:px-6 sm:py-3 sm:text-base"
                  >
                    {downloading ? (
                      <>
                        <div className="h-4 w-4 animate-spin rounded-full border-2 border-white border-t-transparent"></div>
                ...
                <button
                  onClick={onClose}
                  className="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 sm:px-6 sm:py-3 sm:text-base"
                >
                  Close
                </button>
              </div>
            ...
            <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-2xl dark:bg-gray-900">
              <div className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-gray-900 sm:px-6 sm:py-4">
                ...
                <button
                  ...
                  className="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-gray-800 dark:hover:text-gray-300 sm:p-2"
                >
              ...
              <div className="p-4 sm:p-6">
                <div className="mb-4 space-y-4 sm:mb-6 sm:space-y-6">
                  ...
                  {/* Supplier Signature */}
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-gray-900 dark:text-white sm:text-sm">
                  ...
                  <div className="mt-4 sm:mt-6">
                    <label className="flex items-start gap-2 text-xs leading-relaxed text-gray-700 dark:text-gray-300 sm:gap-3 sm:text-sm">
                      <input
                        type="checkbox"
                        checked={termsAgreed}
                ...
                {/* Action Buttons */}
                <div className="flex flex-col gap-2 border-t border-gray-200 pt-4 dark:border-gray-700 sm:flex-row sm:justify-end sm:gap-3 sm:pt-6">
                  <button
                    onClick={() => {
                      setShowAcceptModal(false);
                      setSupplierSignature("");
                    ...
                    className="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 sm:px-6 sm:py-3"
                  >
                    Cancel
                  </button>
                  <button
