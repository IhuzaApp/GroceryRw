          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between border-t border-gray-100 pt-4 transition-colors duration-300 group-hover:border-green-200 dark:border-gray-700 dark:group-hover:border-green-800">
                ...
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-md shadow-green-500/30 transition-all duration-300 group-hover:translate-x-1 group-hover:shadow-lg group-hover:shadow-green-500/50 sm:h-10 sm:w-10" style={{ color: "#ffffff" }}>
                  <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: "#ffffff" }} />
                </div>
              </div>
            </div>
