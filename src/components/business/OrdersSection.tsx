  ...
  return (
    <div className={`space-y-4 md:space-y-8 ${className}`}>
                  ...
                  >
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      <div className="flex-1 space-y-2 md:space-y-4">
                        ...
                        <p className="line-clamp-2 text-xs font-semibold text-gray-900 dark:text-white md:line-clamp-none md:text-base">
                          {order.items}
                        </p>
      ...
      {showOrderDetails && selectedOrder && (
        ...
        >
          <div
            className="h-full max-h-screen w-full max-w-2xl animate-slide-up overflow-y-auto rounded-t-3xl border-l border-r border-t border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800 md:h-auto md:max-h-[90vh] md:animate-none md:rounded-2xl md:border"
          ...
          >
            ...
            <div className="space-y-6 p-6">
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-bold ${getStatusBadgeStyles(
              ...
              <div>
                ...
                <div className="space-y-3">
                  {Array.isArray(selectedOrder.allProducts) &&
                  selectedOrder.allProducts.length > 0 ? (
                    selectedOrder.allProducts.map(
              ...
              <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100 p-4 dark:border-gray-700 dark:from-gray-700/50 dark:to-gray-800/50">
                ...
                <div className="space-y-3">
                  ...
                  {selectedOrder.deliveryAddress && (
                    <button
                      onClick={() =>
                        handleViewLocation(selectedOrder.deliveryAddress)
                      }
                ...
                <div className="rounded-xl border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-yellow-50 p-4 dark:border-orange-800 dark:from-orange-900/20 dark:to-yellow-900/20">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Confirm that all items in this order are available and
                        ready for pickup
                      </p>
                    </div>
                  </div>
