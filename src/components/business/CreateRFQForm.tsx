    ...
    try {
      ...
      const notesContent = formData.additionalNotes
        ? `${formData.additionalNotes}\n\nTerms & Conditions:\nPayment Terms: ${
            ...
            formData.deliveryTerms || "Not specified"
          }\nWarranty: ${
            formData.warrantyInformation || "Not specified"
          }\nCancellation Terms: ${
            formData.cancellationTerms || "Not specified"
          }`
        : `Terms & Conditions:\nPayment Terms: ${
            formData.paymentTerms || "Not specified"
          }\nDelivery Terms: ${
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="50advance50delivery">
