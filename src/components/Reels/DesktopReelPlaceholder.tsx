    ...
    <RootLayout>
      ...
      >
        ...
        <div className="fixed left-8 top-1/2 z-50 -translate-y-1/2 space-y-4 opacity-50">
          <div
            className={`flex h-14 w-14 items-center justify-center rounded-full border shadow-2xl backdrop-blur-xl ${
              isDark
        ...
        <div className="relative z-10 mx-auto flex h-screen w-full items-center justify-center px-4 py-6 lg:gap-8 xl:gap-12">
          ...
          <div className="relative flex animate-pulse flex-col items-center">
            <div
              className={`relative aspect-[9/16] h-[90vh] overflow-hidden rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.1)] ${
                isDark
            ...
            >
              ...
              <div
                className={`absolute inset-0 ${
                  isDark ? "bg-gray-800/40" : "bg-gray-200/40"
                }`}
              />
            ...
            <div className="mt-6 flex gap-4 opacity-50">
              <div
                className={`flex h-12 w-12 items-center justify-center rounded-full border shadow-xl backdrop-blur-md ${
                  isDark
          ...
          <div className="flex h-[90vh] w-full max-w-[500px] animate-pulse flex-col">
            <div
              style={{
                width: "100%",
                height: "90vh",
            ...
            >
              ...
              <div
                className={`p-6 ${isDark ? "bg-black/30" : "bg-white/30"}`}
                  ...
                  >
                    ...
                    <div
                      className={`h-9 w-9 rounded-full ${
                        isDark ? "bg-blue-600/50" : "bg-blue-200"
                      }`}
                    />
                  </div>
                </div>
