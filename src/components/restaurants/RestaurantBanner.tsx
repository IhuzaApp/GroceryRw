...
export const RestaurantBanner: React.FC<RestaurantBannerProps> = React.memo(
  ({ restaurant, onSearch }) => {
    return (
      <div className="relative">
        {/* Mobile Header - Full width with negative margins */}
        <div
          className="relative h-56 w-full overflow-hidden sm:hidden"
          style={{
            marginTop: "-44px",
            marginLeft: "-16px",
            marginRight: "-16px",
        ...
        <div className="relative hidden h-56 w-full overflow-hidden sm:block">
          <Image
            key={`restaurant-banner-desktop-${restaurant.id}`}
            src={restaurant.profile || "/assets/images/restaurantImage.webp"}
            alt={restaurant.name}
            fill
            className="object-cover"
        ...
        <Link
          href="/"
          className="absolute left-4 top-7 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/20 backdrop-blur-md transition-all duration-200 hover:scale-105 hover:bg-white/30 sm:hidden"
        >
          <svg
        ...
        <Link
          href="/"
          className="absolute left-4 top-4 z-20 hidden h-10 w-10 items-center justify-center rounded-full bg-white/90 backdrop-blur-sm transition-colors hover:bg-white sm:flex"
        >
          <svg
        ...
        {/* Search Bar - Mobile */}
        <div className="absolute left-1/2 top-1/2 z-10 w-full max-w-md -translate-x-1/2 -translate-y-1/2 transform px-4 sm:hidden">
          <RestaurantSearchBar
        ...
        {/* Search Bar - Desktop */}
        <div className="absolute left-1/2 top-1/2 z-10 hidden w-full max-w-md -translate-x-1/2 -translate-y-1/2 transform px-4 sm:block">
          <RestaurantSearchBar
            placeholder="Search dishes..."
            onSearch={onSearch}
            isSticky={false}
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 p-4 !text-white sm:hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 hidden p-4 !text-white sm:block">
          <h1 className="text-2xl font-bold !text-white">{restaurant.name}</h1>
          <div className="mt-2 flex flex-wrap items-center gap-4 text-sm !text-white">
            {restaurant.verified && (
              <div className="flex items-center gap-1 !text-white">
