...
const CustomerChatDrawer: React.FC<CustomerChatDrawerProps> = ({
  ...
  return (
    <div className="fixed right-0 top-16 z-[1000] h-[calc(100vh-4rem)] w-80 transform bg-white shadow-xl transition-transform duration-300 ease-in-out dark:bg-gray-800">
      {/* Compact Header */}
