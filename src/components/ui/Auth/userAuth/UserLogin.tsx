    ...
    return (
        <form onSubmit={handleLogin}>
         ...
         <div className="mb-6">
           ...
           <InputGroup inside>
             <Input
               ...
               required
             />
             <InputGroup.Button onClick={() => setShowPassword(!showPassword)} className="text-gray-500">
               {showPassword ? (
         ...
         <Button
           appearance="primary"
           type="submit"
           className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-md mb-4"
         >
           Sign in
         </Button>
         ...
         <Button
           appearance="default"
           className="w-full py-3 rounded-md border flex items-center justify-center gap-2"
         >
