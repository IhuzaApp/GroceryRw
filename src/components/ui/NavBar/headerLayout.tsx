  ...
  return (
    <header className="container sticky top-0 z-50 mx-auto rounded-full border-b bg-white p-2 shadow-lg">
      ...
      <div className="flex items-center justify-between md:hidden px-3 pt-2">
        ...
        {/* Cart Icon */}
        <Link href={"/Cart"} passHref>
          <div className="flex items-center gap-1 rounded-md p-1.5 transition-colors duration-200 hover:cursor-pointer hover:bg-green-50">
            <div className="text-white">
