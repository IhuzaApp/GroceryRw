...
export default function AboutHeader({
  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-lg" : "bg-[#2D5016]"
        }`}
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex cursor-pointer items-center gap-2">
            ...
            />
            <span
              className={`text-2xl font-bold transition-colors ${isScrolled ? "text-[#00D9A5]" : "text-white"
                }`}
            >
              Plas
            </span>
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <Link
              href="/about"
              className={`${activePage === "about" ? "border-b-2 pb-1" : ""
                } font-medium transition-colors ${activePage === "about"
                  ? isScrolled
            ...
            <Link
              href="/life-at-plas"
              className={`${activePage === "life-at-plas" ? "border-b-2 pb-1" : ""
                } font-medium transition-colors ${activePage === "life-at-plas"
                  ? isScrolled
                    ? "border-[#00D9A5] text-[#00D9A5]"
                    : "border-[#00D9A5] text-white"
                  : isScrolled
            ...
            <Link
              ...
              className={`${activePage === "locations" ? "border-b-2 pb-1" : ""
                } font-medium transition-colors ${activePage === "locations"
                  ? isScrolled
                    ? "border-[#00D9A5] text-[#00D9A5]"
                    : "border-[#00D9A5] text-white"
                  : isScrolled
            ...
            <Link
              href="/contact"
              className={`${activePage === "contact" ? "border-b-2 pb-1" : ""
                } font-medium transition-colors ${activePage === "contact"
                  ? isScrolled
                    ? "border-[#00D9A5] text-[#00D9A5]"
                    : "border-[#00D9A5] text-white"
                  : isScrolled
