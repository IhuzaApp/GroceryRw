      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        <div className="mx-auto max-w-3xl">
          <div className="mb-4 inline-flex items-center rounded-full bg-white/10 px-4 py-2 font-medium text-white shadow-sm backdrop-blur-sm">
            ...
            Plas Presence Across the Globe
          </div>
          <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-5xl lg:text-6xl">
            Our <span className="text-[#022C22]">Global Network</span>
          </h1>
          <p className="text-lg font-medium text-white/90 md:text-xl">
            From the bustling tech hubs of Rwanda and South Africa to the
            vibrant markets of the UK and Australia. Plas is expanding its smart
            logistics and business ecosystem to empower entrepreneurs worldwide.
          </p>
        </div>
      </div>
    </section>
