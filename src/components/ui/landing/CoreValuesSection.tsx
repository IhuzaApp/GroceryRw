        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative flex h-96 w-96 items-center justify-center">
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="relative">
                  {/* Rocket Main Body */}
                  <div className="relative mx-auto h-56 w-32">
                    {/* White Rocket Body */}
                    <div className="absolute inset-x-0 bottom-0 top-8 rounded-t-full bg-white"></div>

                    {/* Orange Nose Cone */}
                    <div className="absolute left-1/2 top-0 -translate-x-1/2">
                      <div className="h-0 w-0 border-b-[32px] border-l-[20px] border-r-[20px] border-b-[#FF6B35] border-l-transparent border-r-transparent"></div>
                    </div>
                  ...
                  <div className="absolute -bottom-16 left-1/2 -translate-x-1/2">
                    ...
                    <div className="relative mt-3">
                      <div className="w-18 absolute left-1/2 h-14 -translate-x-1/2 rounded-full bg-blue-300 opacity-40 blur-lg"></div>
                      <div className="absolute left-1/2 top-2 h-10 w-14 -translate-x-1/2 rounded-full bg-blue-200 opacity-30 blur-lg"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <ul className="space-y-4 text-lg leading-relaxed text-white">
              ...
              <li>
                • We work hard and{" "}
                <span className="font-bold">execute fast.</span>
              </li>
              <li>
                • We <span className="font-bold">adapt quickly</span> to
