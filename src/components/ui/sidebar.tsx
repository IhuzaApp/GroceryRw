    ...
    <>
      ...
      <div className="notranslate fixed left-0 top-1/4 z-50 ml-3 hidden rounded-full bg-white shadow-md transition-colors duration-200 dark:bg-gray-800 md:block">
        <div className="flex flex-col items-center gap-6 p-4">
          ...
          {/* Cars Marketplace */}
          <Link
            className={`rounded-full p-2.5 shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 ${
              router.pathname.startsWith("/Cars")
                ? "bg-green-500 text-white shadow-green-500/20 hover:bg-green-600"
                : "text-inherit hover:bg-gray-200 dark:hover:bg-green-700 dark:hover:text-white"
            }`}
            href={"/Cars"}
            passHref
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                <path
                  ...
                  fill={
                    router.pathname.startsWith("/Pets") ? "#FFFFFF" : "#cccccc"
                  }
                ></path>
                <path
                  ...
                  fill={
                    router.pathname.startsWith("/Pets") ? "#FFFFFF" : "#FFFFFF"
                  }
                ></path>
              </g>
            </svg>
