...
import BusinessOpportunitiesDrawer from "./BusinessOpportunitiesDrawer";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Plas for Business - Grow with Africa's Trusted Marketplace"
        />
        <meta
          property="og:description"
          content="Become a partner today. We provide the platform, you bring the items. Let's scale together."
        />
      </Head>
