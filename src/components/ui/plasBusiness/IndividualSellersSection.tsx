...
export default function IndividualSellersSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-emerald-950 py-24 md:py-32">
      {/* Decorative Blur */}
      <div className="absolute left-1/2 top-1/2 h-[400px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#00D9A5] opacity-5 blur-[150px]"></div>

      <div className="container relative z-10 mx-auto px-4">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            <div className="relative">
              <div className="absolute -inset-4 rounded-[60px] bg-[#00D9A5] opacity-20 blur-2xl"></div>
          ...
          <div className="order-1 flex flex-col justify-center lg:order-2">
            ...
            <h2 className="mb-8 text-4xl font-black leading-none tracking-tight text-white md:text-6xl">
              Not a big business?{" "}
              <span className="text-[#00D9A5]">Perfect.</span>
            </h2>
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              {benefits.map((benefit, i) => (
                <div key={i} className="flex flex-col gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-[#00D9A5]">
                    {benefit.icon}
                  </div>
            ...
            <button
              ...
              className="mt-12 w-fit transform rounded-2xl bg-white px-8 py-4 font-black text-emerald-950 transition-all hover:scale-105 hover:bg-[#00D9A5] hover:text-white"
            >
