    ...
    <section className="relative overflow-hidden bg-white py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-[60px] border-[16px] border-emerald-50 bg-[#00D9A5] p-12 shadow-[0_40px_100px_-20px_rgba(0,217,165,0.4)] md:p-24">
            ...
            <div className="relative z-10 text-center">
              <div className="mb-8 inline-block rounded-full bg-emerald-900/10 px-6 py-2 text-sm font-black uppercase tracking-[0.2em] text-emerald-900">
                Zero Cost. Zero Risk.
              </div>
              ...
              <p className="mx-auto mb-12 max-w-3xl text-xl font-bold leading-tight text-emerald-900/80 md:text-3xl">
              ...
              <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
                {[
                  ...
                  >
                    ...
                    <p className="text-sm font-bold uppercase tracking-widest text-emerald-900">
                      {item.desc}
                    </p>
                  </div>
                ))}
