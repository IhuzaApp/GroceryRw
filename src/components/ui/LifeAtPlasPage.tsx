  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex items-center justify-center">
                <div
                  ...
                  style={{
                    ...
                    height: "550px",
                    clipPath:
                      "path('M 225 0 C 300 0 375 50 400 150 C 425 250 400 350 350 450 C 300 500 225 550 225 550 C 225 550 150 500 100 450 C 50 350 25 250 50 150 C 75 50 150 0 225 0 Z')",
                  }}
                >
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="space-y-4 text-lg leading-relaxed text-gray-800">
                  <p>
                    Our platform connects people with possibilities. Our mission
                    is to give everyone easy access to anything in their city.
                  </p>
                  <p>
                    Our global team works together by leveraging the latest
                    technology to connect to possibilities. We believe in paving
                    the way together. Do you?
                  </p>
                </div>
                <button
            ...
            <div className="mb-16 grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="relative flex flex-col space-y-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 text-lg leading-relaxed text-gray-800">
                    <p>
                      From helping you experience each day to the fullest,
                      sharing memorable moments along the way, to investing in
                      your future...{" "}
                      <strong>We&apos;ve got you covered!</strong>
                    </p>
                    <p className="text-sm text-gray-600">
                      *The perks and benefits can change depending on the
                      location.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center">
                <div
                  ...
                  style={{
                    ...
                    height: "600px",
                    clipPath:
                      "path('M 250 0 C 350 0 420 50 450 150 C 480 250 490 350 480 450 C 470 520 420 570 350 590 C 300 600 200 600 150 590 C 80 570 30 520 20 450 C 10 350 20 250 50 150 C 80 50 150 0 250 0 Z')",
                  }}
                >
                  <div className="absolute inset-0">
                    <Image
            ...
            <div className="relative">
              <div className="flex items-center justify-center gap-4">
                ...
                <button
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-full bg-gray-300 text-gray-700 transition-colors hover:bg-gray-400 ${
                ...
                <div className="max-w-5xl flex-1 overflow-hidden">
                  <div
        ...
        <div className="relative overflow-hidden bg-[#2C2C2C] py-16 md:py-24">
                ...
                {activeSection === "office-life" ? (
                  <>
                    ...
                    <p className="text-lg leading-relaxed md:text-xl">
                      ...
                      collaboration and relationships are placed at the center.
                      We believe{" "}
                      <strong>
                        our culture comes alive and thrives when we get together
                        and collaborate!
                      </strong>
                    </p>
                  </>
                  ...
                  <>
                    ...
                    <p className="text-lg leading-relaxed md:text-xl">
                      At Plas we are building a talent house of high performing
                      teams and future leaders. We believe that talent is our
                      biggest asset, and being surrounded by top talent will
                      help us raise the bar and create high performing teams,
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-3xl text-lg text-gray-700">
                Find out how Plas is committed to making a positive impact on
                society, by shaping a social-responsible and eco-friendly growth
                model!
              </p>
            </div>
                ...
                >
                  ...
                  <div className="min-w-full flex-shrink-0 px-20 py-16">
                    <div className="flex items-center justify-center gap-16">
                      ...
                      {/* Text */}
                      <div className="flex max-w-md flex-1 flex-col justify-center space-y-6">
                        <h3 className="text-4xl font-bold text-gray-800 lg:text-5xl">
                          Plasers
                        </h3>
                        <p className="text-lg leading-relaxed text-gray-700">
                          Plas is leading the way in improving Plasers'
                          experience by adding extra benefits. By connecting to
                          the platform, Plasers are able to access numerous
                  ...
                  <div className="min-w-full flex-shrink-0 px-20 py-16">
                    <div className="flex items-center justify-center gap-16">
                      ...
                      <div className="flex max-w-md flex-1 flex-col justify-center space-y-6">
                        ...
                        <p className="text-lg leading-relaxed text-gray-700">
                          Small businesses should be able to thrive through our
                          platform. That's why we're safeguarding the city's
                          local commerce and being an enabler for small
                          businesses to grow.
                        </p>
                      </div>
                      {/* Image - Blob Shape */}
                  ...
                  <div className="min-w-full flex-shrink-0 px-20 py-16">
                    <div className="flex items-center justify-center gap-16">
                      ...
                      <div className="flex max-w-md flex-1 flex-col justify-center space-y-6">
                        ...
                        <p className="text-lg leading-relaxed text-gray-700">
                          At Plas, we aim to use our technologies to contribute
                          to society. With the goal of reducing hunger in the
                          communities around us, we support NGOs by means of our
                          technological tools, by helping the food surplus
                          produced by our partners, and by delivering essential
                          goods and social meals.
                        </p>
                      </div>
                      {/* Image */}
                      <div className="flex-shrink-0">
                  ...
                  <div className="min-w-full flex-shrink-0 px-20 py-16">
                    <div className="flex items-center justify-center gap-16">
                      ...
                      <div className="flex max-w-md flex-1 flex-col justify-center space-y-6">
                        ...
                        <p className="text-lg leading-relaxed text-gray-700">
                          Plas has been carbon neutral since 2024. Yet, we keep
                          accelerating the transition towards environmental
                          sustainability, by boosting sustainable packaging,
                          reducing CO2 emissions from vehicles, and eradicating
                          food waste.
                        </p>
                      </div>
                    </div>
        ...
        <div className="relative overflow-hidden bg-gray-100 py-16 md:py-24">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mb-24">
              <h2 className="mb-16 text-center text-3xl font-bold text-gray-800 md:text-4xl lg:text-5xl">
                We are a diverse, creative group of people who
                <br />
              ...
              <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                <div className="flex flex-col space-y-6">
                  <h4 className="text-xl font-bold text-gray-800 md:text-2xl">
                    We want to make a meaningful impact through technology and
                    engineering
                  </h4>
                  <p className="text-base leading-relaxed text-gray-700">
                    By using our experience and maximizing the use of technology
                    and automation to <strong>solve complex problems,</strong>{" "}
                    we aim to provide anyone easy access to anything in their
                    city.
                  </p>
                </div>
              </div>
            ...
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex flex-col space-y-6">
                ...
                <p className="text-base leading-relaxed text-gray-700">
                  As of now, our tech team consists of around{" "}
                  <strong>500 top talented engineers</strong>, with the plan of
                  continuing scaling it in the next upcoming years. We believe
                  that{" "}
                  <strong>diversity adds incredible value to our teams</strong>,
                  products and culture and we support and empower women in tech,
                  making it one of the priorities when accessing talents.
                </p>
              </div>
        ...
        <div className="bg-white py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-6xl">
              {/* Technology Stack */}
              <div className="mb-20">
                <h4 className="mb-8 text-center text-2xl font-bold text-gray-800 md:text-3xl">
                  We want to build the fastest and most easy-to-use app
                </h4>
                <div className="mx-auto mb-12 max-w-4xl space-y-4 text-center">
                  <p className="text-base text-gray-700">
                    Leveraging our modern technology stack including Next.js,
                    React, and TypeScript, powered by Firebase and GraphQL.
                  </p>
                  <p className="text-base text-gray-700">
                ...
                <div className="mx-auto grid max-w-5xl grid-cols-2 items-center justify-items-center gap-8 md:grid-cols-3 md:gap-12">
                  {/* Next.js */}
                  ...
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M134.417 148.974L134.417 148.974 102.739 90.418 1.253 280.732l133.164 69.083 133.155-69.083-133.155-131.758z"
                        fill="#F4BD62"
                      />
                      <path
                        d="M134.417 148.974l133.155 131.758-133.155 69.083V148.974z"
                        fill="#FFA50E"
                      />
                      <path
                        d="M103.739 91.418L1.253 280.732l99.353-188.518 3.133-1.796z"
                        fill="#F6820C"
                      />
                    </svg>
                    <span className="text-sm font-semibold text-gray-700">
                  ...
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    >
                      <path
                        d="M152.576 32.964l59.146 34.15a25.819 25.819 0 0116.729 24.296v68.3a25.819 25.819 0 01-16.729 24.296l-59.146 34.15a25.819 25.819 0 01-25.152 0l-59.146-34.15a25.819 25.819 0 01-16.729-24.296v-68.3a25.819 25.819 0 0116.729-24.296l59.146-34.15a25.819 25.819 0 0125.152 0z"
                        fill="#E10098"
                      />
                      <path
                        d="M152.576 32.964l59.146 34.15a25.819 25.819 0 0116.729 24.296v68.3"
                        stroke="#E10098"
                        strokeWidth="8"
                      />
                      <path
                        d="M75 144.5l-32-18.5"
                        stroke="#E10098"
                        strokeWidth="8"
                      />
                      <path
                        d="M213 144.5l32-18.5"
                        stroke="#E10098"
                        strokeWidth="8"
                      />
                    </svg>
