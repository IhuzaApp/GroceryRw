        ...
        <div className="relative h-full w-full flex items-center justify-center">
          <div className="relative">
            ...
            <div 
              ...
              style={{
                background: "radial-gradient(circle, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.3) 30%, rgba(255, 255, 255, 0.15) 60%, transparent 100%)",
            ...
            <div 
              ...
              style={{
                background: "radial-gradient(ellipse, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.4) 40%, transparent 80%)",
            ...
            <Image
              ...
              width={250}
              height={250}
              className="h-full w-auto object-contain max-w-[280px] relative z-10"
              style={{
                animation: "float 3s ease-in-out infinite 0.5s, glow 3s ease-in-out infinite",
                filter: "drop-shadow(0 0 4px rgba(255, 255, 255, 0.3)) drop-shadow(0 0 8px rgba(255, 255, 255, 0.2))",
              }}
            />
          </div>
        </div>
