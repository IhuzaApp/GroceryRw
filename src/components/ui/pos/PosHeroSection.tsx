            ...
            <div className="container relative mx-auto px-4 z-10">
                <div className="grid items-center gap-12 md:grid-cols-2">
                    ...
                    <div className="relative mx-auto w-full max-w-lg md:max-w-none">
                        <div className="relative aspect-square w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10">
                            <Image
                        ...
                        <div className="absolute -bottom-6 -left-6 rounded-2xl bg-white p-4 shadow-xl md:p-6 animate-bounce" style={{ animationDuration: '3s' }}>
                            <div className="flex items-center gap-4">
                                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#00D9A5]/20">
                                    <svg className="h-6 w-6 text-[#00A67E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                </div>
                                <div>
                                    <p className="text-sm font-bold text-gray-500">AI Powered</p>
                                    <p className="text-lg font-bold text-[#1A1A1A]">Smart Tax & Payroll</p>
                                </div>
                            </div>
                        </div>
                    </div>
