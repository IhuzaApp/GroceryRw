            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto max-w-3xl text-lg text-gray-600">
                        From ringing up sales to forecasting taxes, our end-to-end management ecosystem empowers your shop, restaurant, or enterprise to operate at peak efficiency.
                    </p>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {featureCategories.map((category, index) => (
                        <div
                            key={index}
                            className={`rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg ${index === 4 ? 'lg:col-span-2 lg:max-w-3xl lg:justify-self-center w-full' : ''}`}
                        >
                                ...
                                {category.features.map((feature, fIndex) => (
                                    <li key={fIndex} className="flex items-start gap-3">
                                        <div className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#00A67E]/10">
                                            <svg className="h-3 w-3 text-[#00A67E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
