          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {days.map((day) => {
              ...
              return (
                <div
                  key={day}
                  className={`space-y-4 rounded-2xl border-2 p-5 transition-all duration-300 ${
                    isClosed
                      ? "border-gray-100 bg-gray-50/50 opacity-80"
                      : "border-gray-100 bg-white shadow-sm shadow-gray-200/50 hover:border-[#022C22]/20"
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-sm font-extrabold capitalize ${
                        isClosed ? "text-gray-400" : "text-[#1A1A1A]"
                      }`}
                    >
                      {day}
                    </span>
                  ...
                  {!isClosed ? (
                    <div className="space-y-4 border-t border-gray-50 pt-4">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="h-12 w-full rounded-xl border-2 border-gray-100 bg-gray-50 px-4 text-sm font-bold text-[#1A1A1A] outline-none transition-all focus:border-[#022C22] focus:bg-white"
                        />
                      </div>
                    ...
                    <div className="flex h-[160px] flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200/50 bg-gray-100/50">
