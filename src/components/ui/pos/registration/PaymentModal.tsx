...
export default function PaymentModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm duration-300 animate-in fade-in">
      <div className="relative w-full max-w-lg overflow-hidden rounded-[2.5rem] bg-white shadow-2xl duration-300 animate-in zoom-in-95">
        <button
          onClick={onClose}
        ...
        <div className="p-8 md:p-12">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-gray-500">
              Securely finalize your {plan?.name} subscription
            </p>
          </div>
          ...
          <div className="mb-8 flex items-center justify-between rounded-2xl bg-gray-50 p-6">
            ...
            <div className="text-2xl font-bold text-[#022C22]">
              ...
              <span className="text-sm opacity-60">RWF</span>
            </div>
          </div>
          ...
          {method === "momo" ? (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-14 w-full rounded-xl border-2 border-gray-100 bg-gray-50 pl-12 pr-4 text-lg font-medium text-black outline-none focus:border-[#022C22] focus:bg-white"
                    placeholder="078..."
                  />
                </div>
              </div>
            ...
            <div className="space-y-6 rounded-3xl border-2 border-dashed border-gray-100 bg-gray-50/50 p-8 text-center">
              ...
              <p className="text-sm text-gray-500">
                We are currently integrating with local card processors. Please
                use MTN MoMo for now.
              </p>
