                ...
                {registrationSteps
                    ...
                    .map((s, idx) => {
                        ...
                        return (
                            <div
                                key={s.id}
                                className={`flex items-center gap-4 rounded-2xl border p-4 transition-all duration-500 ${isError
                                    ? "border-red-200 bg-red-50"
                                    : isActive
                                        ? "border-[#022C22] bg-[#022C22]/5 translate-x-1 shadow-md shadow-[#022C22]/5"
                                        : isDone
                            ...
                            >
                                <div
                                    className={`flex h-10 w-10 items-center justify-center rounded-full transition-all duration-500 ${isDone
                                        ? "bg-[#00c596] text-white"
                                        : isError
                                            ? "bg-red-500 text-white"
                                            : isActive
                                                ? "bg-[#022C22] text-white animate-pulse"
                                ...
                                <div className="flex-1">
                                    <div
                                        className={`text-sm font-bold transition-all duration-500 ${isError
                                            ? "text-red-700"
                                            : isActive
                                                ? "text-[#022C22]"
                                                : isDone
