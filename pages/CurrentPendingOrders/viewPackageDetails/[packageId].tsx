      ...
      <RootLayout>
        <div className="container mx-auto px-4 py-12 text-center">
          <div className="rounded-2xl bg-red-50 p-8 dark:bg-red-900/10">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">{error || "Package not found"}</p>
            <Button appearance="primary" color="red" className="mt-6" onClick={() => router.back()}>
              Go Back
            </Button>
          </div>
        </div>
      ...
      <RootLayout>
        <div className="min-h-screen pb-20 md:pb-10">
          ...
          <div className="relative h-52 w-full md:h-80">
            ...
            <button
              onClick={() => router.back()}
              className="absolute left-6 top-6 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/20 backdrop-blur-xl transition-all hover:bg-white/30 hover:scale-110 active:scale-95"
            >
            ...
            {pkg.shopper && (
              <div className="absolute left-1/2 top-6 z-20 -translate-x-1/2">
                <div className="flex items-center gap-3 rounded-full bg-black/40 px-3 py-1.5 backdrop-blur-xl ring-1 ring-white/20 shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="space-y-6 lg:col-span-2">
                ...
                <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
                  ...
                  <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{statusInfo.description}</p>
                </div>
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <div className="relative space-y-8">
                    ...
                    <div className="relative flex gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Pickup</p>
                        <p className="mt-1 font-medium">{pkg.pickupLocation}</p>
                        {formatLocationDetails(pkg.pickupDetials) && (
                          <p className="mt-1 text-sm text-gray-500 italic">“{formatLocationDetails(pkg.pickupDetials)}”</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="relative flex gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Dropoff</p>
                        <p className="mt-1 font-medium">{pkg.dropoffLocation}</p>
                        {formatLocationDetails(pkg.dropoffDetails) && (
                          <p className="mt-1 text-sm text-gray-500 italic">“{formatLocationDetails(pkg.dropoffDetails)}”</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                {pkg.comment && (
                  <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <p className="mt-3 text-gray-600 dark:text-gray-400">{pkg.comment}</p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-full border-2 border-green-100 dark:border-green-900/30">
                        <Image
                          src={pkg.shopper.profile_photo || "/images/avatar-placeholder.jpg"}
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{pkg.delivery_fee.toLocaleString()} RWF</span>
                    </div>
                    <div className="border-t border-gray-100 pt-3 dark:border-gray-800">
                      <div className="flex items-center justify-between">
                        <p className="text-lg font-black tracking-tight">Total Amount</p>
                ...
                <div className="flex items-center gap-3 rounded-2xl border border-dashed border-gray-200 p-4 dark:border-gray-800">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{new Date(pkg.created_at).toLocaleString()}</p>
                  </div>
                </div>
              </div>
