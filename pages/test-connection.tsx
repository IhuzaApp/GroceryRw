        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <Panel header="Apollo Client Connection Test" bordered shaded>
              <p className="mb-4">
                This tests if your frontend can connect to Hasura directly using Apollo Client.
              </p>
          ...
          <div className="mt-8">
            <Panel header="Troubleshooting" bordered>
              ...
              <ul className="list-inside list-disc space-y-2">
                <li>
                  <strong>Connection refused errors:</strong> Make sure your Hasura server is running and accessible.
                </li>
                <li>
                  <strong>Environment variables:</strong> Check that <code>NEXT_PUBLIC_HASURA_GRAPHQL_URL</code> and <code>HASURA_GRAPHQL_URL</code> are set correctly.
                </li>
                <li>
                  <strong>CORS issues:</strong> Ensure Hasura is configured to allow requests from your frontend domain.
                </li>
                <li>
                  <strong>Authentication:</strong> Verify that authentication headers are being sent correctly.
                </li>
              </ul>
            </Panel>
          </div>
