              ...
              <div className="lg:col-span-2">
                <div className="rounded-lg bg-white p-8 shadow-lg md:p-12">
                  ...
                  <p className="mb-8 text-base leading-relaxed text-gray-700">
                    Do you want to know more about careers at Plas, or do you have any concerns about your recruitment process? We love hungry minds, so don't be shy and send us your doubts!
                  </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <label className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-gray-700">
                          ...
                          <a href="/privacy-policy" className="text-[#00D9A5] underline hover:text-[#00C896]">
                            Privacy Policy
                          </a>{" "}
                  ...
                  <div className="mt-8 text-xs text-gray-600">
                    <p>
                      Plas Technologies Ltd. may process the data you share with us in your request for the purpose of providing you with the answer regarding your request. For more information on how we process your data and how to exercise your rights, please refer to our{" "}
                      <a href="/privacy-policy" className="text-[#00D9A5] underline hover:text-[#00C896]">
                        Privacy Policy
                      </a>
                      .
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-sm text-gray-700">
                        Don't worry, we won't spam you. Your details are only used to answer you.
                      </p>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Your question and our answer will be visible to everyone. If your question has been answered before, you'll be sent a link to the answer.
                      </p>
                    </div>
                  </div>
                </div>
