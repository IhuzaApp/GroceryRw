    ...
    <ThemeProvider>
      <div className="h-screen overflow-hidden bg-white dark:bg-black">
        <div className="flex h-full lg:h-screen">
          ...
          <div
            className={`${
              isSuccess ? "w-full" : "w-full lg:w-1/2"
            } flex flex-col items-center justify-center overflow-y-auto px-4 py-8 lg:px-16 lg:py-8`}
          >
            <div className="w-full max-w-md">
              ...
              <div
                className={
                  !isSuccess
                    ? "rounded-2xl bg-white/80 p-4 text-black shadow-xl backdrop-blur-sm dark:bg-[#171717]/80 dark:text-white lg:p-8"
                    : ""
                }
              >
                <UserRegistration
