    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden bg-gray-100 lg:block lg:w-1/2">
        ...
        <div className="absolute bottom-8 left-8 max-w-md rounded-lg bg-white bg-opacity-90 p-6">
          <h2 className="mb-2 text-xl font-bold">Shop smarter, not harder</h2>
          <p className="text-gray-600">
            Join thousands of customers who save time and money by ordering
            groceries online with our easy-to-use platform.
          </p>
        </div>
      </div>
    </div>
