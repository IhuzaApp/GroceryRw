    ...
    try {
      if (status === "authenticated") {
        ...
        if (!queryEmail || !queryName) {
          throw new Error(
            "Missing registration details. Please try signing in again."
          );
        }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 transition-all duration-200 focus:border-green-500 focus:ring-2 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex w-full items-center justify-center rounded-xl bg-green-600 py-3 font-semibold text-white transition-all duration-200 hover:bg-green-700 disabled:opacity-50"
              >
                {isLoading ? (
                  <svg
