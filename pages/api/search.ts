...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const productsResponse = await hasuraClient.request(productsQuery, { searchTerm }) as any;
    ...
    const shopsResponse = await hasuraClient.request(shopsQuery, { searchTerm }) as any;
