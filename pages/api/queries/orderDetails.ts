...
export default async function handler(
  ...
  try {
    ...
    const formattedOrder = {
      ...order,
      placedAt: new Date(order.placedAt).toLocaleString('en-US', { dateStyle: 'medium', timeStyle: 'short' }),
      estimatedDelivery: new Date(order.estimatedDelivery).toLocaleString('en-US', { dateStyle: 'medium', timeStyle: 'short' }),
    };
