          ...
          {!isMobile && isInitialized && (
            <div className="container mx-auto h-full px-0 py-0 pb-0 sm:px-4 sm:py-6 sm:pb-8 lg:px-6 lg:py-8">
              <div className="mx-auto h-full w-full">
                ...
                <div
                  className={`mb-6 grid grid-cols-1 gap-4 sm:mb-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 ${
                    theme === "dark" ? "!text-white" : "text-gray-800"
                  }`}
                >
                  {loading ? (
                  ...
                  >
                    ...
                    >
                      <Panel
                        shaded
                        bordered
                        className={`mt-4 h-full p-4 sm:mt-6 sm:p-6 ${
                          theme === "dark"
                ...
                <div className="mt-6 grid grid-cols-1 gap-6 sm:mt-8 sm:gap-8 lg:grid-cols-2">
                  {deliveryStatsLoading ? (
                    <div className="flex h-64 items-center justify-center rounded-lg border sm:h-96">
                      ...
                      <div className="flex space-x-2 overflow-x-auto pb-2">
                        {[
                          ...
                          <button
                            ...
                            className={`flex min-w-fit items-center space-x-2 whitespace-nowrap rounded-xl px-4 py-3 text-sm font-semibold transition-all duration-300 ${
                              activeTab === tab.key
                                ? theme === "dark"
                                  ? "scale-105 transform bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg shadow-green-500/40"
                                  : "scale-105 transform bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg shadow-green-500/40"
                                : theme === "dark"
                                ? "border border-gray-700 bg-gray-800/50 text-gray-300 hover:bg-gray-700/50 hover:text-white"
                                : "border border-gray-200 bg-white text-gray-600 shadow-sm hover:bg-gray-50 hover:text-gray-900"
                            }`}
                          >
