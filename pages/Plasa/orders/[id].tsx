        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <div className="flex min-h-[60vh] items-center justify-center">
              ...
              <Link href="/">
                  <button className="rounded-lg bg-blue-600 px-6 py-3 text-white font-medium transition-colors hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
            ...
            <div className="space-y-6">
                ...
                <div className="p-6 sm:p-8">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">
                          {orderDetails.orderType === 'reel' ? 'Reel Order' : 'Order'} #{orderDetails.id.slice(0, 8)}
                        </h1>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-green-600 dark:text-green-400">Your Earnings</p>
                ...
                >
                  <div className="p-6">
                    <h3 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">
                      {orderDetails.orderType === 'reel' ? 'Pickup Location' : 'Shop Information'}
                    </h3>
                  ...
                  <div className="p-6">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                            {orderDetails.reel.description || 'No description available'}
                          </p>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="rounded-lg bg-white/30 p-4 dark:bg-gray-800/30">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Quantity</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{orderDetails.quantity}</p>
                      </div>
                      <div className="rounded-lg bg-white/30 p-4 dark:bg-gray-800/30">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Price per item</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    ...
                    {orderDetails.deliveryNote && (
                      <div className="mt-6 rounded-lg bg-white/30 p-4 dark:bg-gray-800/30">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Delivery Note</p>
                        <p className="text-gray-900 dark:text-white">{orderDetails.deliveryNote}</p>
                      </div>
                    )}
              ...
              >
                ...
                {orderDetails.status === "PENDING" && (
                    <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                      ...
                      disabled={isAccepting}
                        className="flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-green-500 to-green-600 px-6 py-3 text-white font-semibold transition-all duration-200 hover:from-green-600 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isAccepting ? (
                          <>
                ...
                {orderDetails.status === "ASSIGNED" && (
                    <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                      <button className="flex items-center justify-center gap-2 rounded-lg border border-red-300 bg-red-50 px-6 py-3 text-red-700 font-semibold transition-colors hover:bg-red-100 dark:border-red-700 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30">
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                        </svg>
                      Cancel Batch
                      </button>
                      <button className="flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-3 text-white font-semibold transition-all duration-200 hover:from-blue-600 hover:to-blue-700">
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
